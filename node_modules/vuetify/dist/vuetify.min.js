...
n.push(`--${t}theme-${o}: ${e.r},${e.g},${e.b}`+(null==e.a?"":`,${e.a}`)),o.startsWith("on-")||n.push(`--${t}theme-${o}-overlay-multiplier: ${lt(r)>.18?a:l}`)}for(const[a,l]of Object.entries(e.variables)){const e="string"==typeof l&&l.startsWith("#")?He(l):void 0,o=e?`${e.r}, ${e.g}, ${e.b}`+(null==e.a?"":`, ${e.a}`):void 0
...
return t.createVNode(zl,t.mergeProps({class:["v-btn-toggle",{"v-btn-toggle--has-color":!!e.color},e.class]},s,{style:e.style}),{default:()=>[a.default?.({isSelected:l,next:n,prev:o,select:r,selected:i})]})}),{next:n,prev:o,select:r}}}),Kl=["x-small","small","default","large","x-large"],ql=rt({size:{type:[String,Number],default:"default"}},"size")
...
let s=!1,u=!1,c=!0
const d=t.computed(()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover),v=t.computed(()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!d.value),{runOpenDelay:p,runCloseDelay:m}=ni(e,t=>{t!==(e.openOnHover&&s||d.value&&u)||e.openOnHover&&a.value&&!l.value||(a.value!==t&&(c=!0),a.value=t)})
let f=!1
t.watch(a,e=>{e||(f=!0,setTimeout(()=>f=!1,50))})
const g=t.ref(),h=e=>{f&&!a.value||(e.stopPropagation(),i.value=e.currentTarget||e.target,a.value||(g.value=[e.clientX,e.clientY]),a.value=!a.value)},y=e=>{s=!0,i.value=e.currentTarget||e.target,p()},b=e=>{s=!1,m()},V=e=>{f||!1!==J(e.target,":focus-visible")&&(u=!0,e.stopPropagation(),i.value=e.currentTarget||e.target,p())},w=e=>{const t=e.relatedTarget
t&&!n.value?.contains(t)&&(u=!1,e.stopPropagation(),m({minDelay:1}))},S=t.computed(()=>{const t={}
return v.value&&(t.onClick=h),e.openOnHover&&(t.onMouseenter=y,t.onMouseleave=b),d.value&&(t.onFocus=V,t.onBlur=w),t}),k=t.computed(()=>{const l={}
...
t&&!n.value?.contains(t)&&(u=!1,m({minDelay:1}))}),e.closeOnContentClick){const e=t.inject(ai,null)
l.onClick=()=>{a.value=!1,e?.closeParents()}}return l}),x=t.computed(()=>{const t={}
return e.openOnHover&&(t.onMouseenter=()=>{c&&(s=!0,c=!1,p())},t.onMouseleave=()=>{s=!1,m()}),t})
t.watch(l,t=>{!t||(!e.openOnHover||s||d.value&&u)&&(!d.value||u||e.openOnHover&&s)||n.value?.contains(document.activeElement)||m()}),t.watch(a,e=>{e||setTimeout(()=>{g.value=void 0})},{flush:"post"})
const N=ae()
t.watchEffect(()=>{N.value&&t.nextTick(()=>{i.value=N.el})})
const E=ae(),I=t.computed(()=>"cursor"===e.target&&g.value?g.value:E.value?E.el:ii(e.target,r)||i.value),_=t.computed(()=>Array.isArray(I.value)?void 0:I.value)
let P
return t.watch(()=>!!e.activator,a=>{a&&o?(P=t.effectScope(),P.run(()=>{!function(e,a,{activatorEl:l,activatorEvents:n}){function o(a=i(),l=e.activatorProps){a&&function(e,t){Object.keys(t).forEach(a=>{if(C(a)){const l=W(a),n=Ve.get(e)
...
e&&r(e)}e&&t.nextTick(()=>o())},{immediate:!0}),t.watch(()=>e.activatorProps,()=>{o()}),t.onScopeDispose(()=>{r()})}(e,r,{activatorEl:i,activatorEvents:S})})):P&&P.stop()},{flush:"post",immediate:!0}),t.onScopeDispose(()=>{P?.stop()}),{activatorEl:i,activatorRef:N,target:I,targetEl:_,targetRef:E,activatorEvents:S,contentEvents:k,scrimEvents:x}}function ii(e,t){if(!e)return
let a
...
for(const{isActive:t,contentEl:a}of ui.values())t.value&&a.value&&(e=a.value)
return e}()
if(!t)return
const a=K(t).filter(e=>e.tabIndex>=0)
return e.preventDefault(),void(a.length?e.shiftKey?a[a.length-1].focus():a[0].focus():t.focus({preventScroll:!0}))}const o=K(l).filter(e=>e.tabIndex>=0)
if(!o.length)return
...
e.shiftKey&&s&&(e.preventDefault(),i.focus()),!e.shiftKey&&u&&(e.preventDefault(),r.focus())}function vi(e,{isActive:a,localTop:l,contentEl:n}){const r=Symbol("trap")
let i=!1,s=-1
async function u(){i=!0,s=window.setTimeout(()=>{i=!1},100)}async function c(e){const o=e.relatedTarget,r=e.target
if(document.removeEventListener("pointerdown",u),document.removeEventListener("keydown",d),await t.nextTick(),a.value&&!i&&o!==r&&n.value&&t.toValue(l)&&![document,n.value].includes(r)&&!n.value.contains(r)){const e=K(n.value)
e[0]?.focus()}}function d(e){if("Tab"===e.key&&(document.removeEventListener("keydown",d),a.value&&n.value&&e.target&&!n.value.contains(e.target))){const t=K(document.documentElement)
if(e.shiftKey&&e.target===t.at(0)||!e.shiftKey&&e.target===t.at(-1)){const t=K(n.value)
t.length>0&&(e.preventDefault(),t[0].focus())}}}const v=t.toRef(()=>a.value&&e.captureFocus&&!e.disableInitialFocus)
o&&(t.watch(()=>e.retainFocus,e=>{e?ui.set(r,{isActive:a,contentEl:n}):ui.delete(r)},{immediate:!0}),t.watch(v,e=>{e?(document.addEventListener("pointerdown",u),document.addEventListener("focusin",c,{once:!0}),document.addEventListener("keydown",d)):(document.removeEventListener("pointerdown",u),document.removeEventListener("focusin",c),document.removeEventListener("keydown",d))},{immediate:!0}),ci++<1&&document.addEventListener("keydown",di)),t.onScopeDispose(()=>{ui.delete(r),o&&(clearTimeout(s),document.removeEventListener("pointerdown",u),document.removeEventListener("focusin",c),document.removeEventListener("keydown",d),--ci<1&&document.removeEventListener("keydown",di))})}function pi(){if(!o)return t.shallowRef(!1)
const{ssr:e}=Ro()
...
let l
t.watchEffect(async()=>{l?.stop(),a.isActive.value&&e.scrollStrategy&&(l=t.effectScope(),await new Promise(e=>setTimeout(e)),l.active&&l.run(()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(a,e,l):Qr[e.scrollStrategy]?.(a,e,l)}))}),t.onScopeDispose(()=>{l?.stop()})}(e,{root:i,contentEl:u,targetEl:N,target:x,isActive:d,updateLocation:B}),vi(e,{isActive:d,localTop:V,contentEl:u}),t.watch(d,e=>{e||function(){const e=S.value
if(!e||!e.isConnected)return
if(e.closest(".v-overlay__content"))return
if(u.value?._clickOutside?.lastMousedownWasOutside)return
const t=document.activeElement
if(t&&t!==document.body&&t!==e&&!e.contains(t)&&!t.closest(".v-overlay__content"))return
const a=e.parentElement
let l
if((a?K(a):[]).includes(e))l=e
else{const t=K(e)
l=t.find(e=>"INPUT"===e.tagName||"TEXTAREA"===e.tagName)??t[0]}l?.focus({preventScroll:!0})}()},{flush:"post"}),o&&t.watch(d,e=>{e?window.addEventListener("keydown",M):window.removeEventListener("keydown",M)},{immediate:!0}),t.onBeforeUnmount(()=>{o&&window.removeEventListener("keydown",M)})
const L=pn()
...
function Xi(e,t,a){return function(l){return!(l.relatedTarget||document.activeElement!==document.body||!e.value)&&(requestAnimationFrame(()=>{if(!e.value)return
const l=t(),n=(l&&K(l)[0])??a()
n?.focus({preventScroll:!0})}),!0)}}function Zi(e,a){const l=t.shallowRef(!1)
let n
...
return e.hideSelected?t.filter(t=>!g.value.some(a=>(e.valueComparator||ht)(a,t))):t}),I=t.computed(()=>e.hideNoData&&!E.value.length||y.isReadonly.value||y.isDisabled.value),_=Zt(e,"menu"),R=t.computed({get:()=>_.value,set:e=>{_.value&&!e&&r.value?.ΨopenChildren.size||e&&I.value||(_.value=e)}}),{menuId:A,ariaExpanded:T,ariaControls:D}=os(0,R),B=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),F=t.ref(),$=Zi(F,n),M=Xi(R,()=>r.value?.contentEl,()=>n.value?.controlRef),{onTabKeydown:z}=Qi({groups:[{type:"element",contentRef:i},{type:"list",contentRef:F,displayItemsCount:()=>E.value.length},{type:"element",contentRef:s}],onLeave:()=>{R.value=!1,n.value?.focus()}})
function L(t){e.openOnClear&&(R.value=!0)}function O(){I.value||(R.value=!R.value)}function j(e){"Tab"===e.key&&z(e),F.value?.$el.contains(e.target)&&le(e)&&H(e)}function H(t){if(!t.key||y.isReadonly.value)return
if(["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(R.value=!0),["Escape","Tab"].includes(t.key)&&(R.value=!1),e.clearable&&"Backspace"===t.key)return t.preventDefault(),g.value=[],void L()
...
if(!o)return
const[r,i]=o
C=i,F.value?.focus(i),e.multiple||(g.value=[r])}function W(a,l=!0){if(!a.props.disabled)if(e.multiple){const t=g.value.findIndex(t=>(e.valueComparator||ht)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...g.value,a]:[...g.value]
e.splice(t,1),g.value=e}else n&&(g.value=[...g.value,a])}else{const e=!1!==l
g.value=e?[a]:[],t.nextTick(()=>{R.value=!1})}}function U(e){const t=e.target
n.value?.$el.contains(t)||(R.value=!1)}function Y(){if(e.eager&&u.value?.calculateVisibleItems(),F.value&&w.value){const t=function(){if(!g.value.length)return-1
...
F.value.focus(t>=0?t:"first",{focusVisible:!1})}}function G(){p.value="",w.value&&n.value?.focus()}function K(e){w.value=!0}function q(e){if(!n.value?.$el.contains(e.relatedTarget)&&!e.currentTarget.contains(e.relatedTarget)){if(M(e))return
w.value=!1}}function X(e){if(null==e)g.value=[]
else if(J(n.value,":autofill")||J(n.value,":-webkit-autofill")){const t=c.value.find(t=>t.title===e)
t&&W(t)}else n.value&&(n.value.value="")}return t.watch(R,()=>{if(!e.hideSelected&&R.value&&g.value.length){const t=E.value.findIndex(t=>g.value.some(a=>(e.valueComparator||ht)(a.value,t.value)))
...
const e=d.value+1
V.value[e]?d.value=e:(d.value=-1,n.value?.setSelectionRange(0,0))}else~d.value&&le(t)&&(d.value=-1)}function X(e){if(J(n.value,":autofill")||J(n.value,":-webkit-autofill")){const t=p.value.find(t=>t.title===e.target.value)
t&&ce(t)}}function Z(){e.eager&&c.value?.calculateVisibleItems()}function te(){r.value&&(u.value?.contentEl?._clickOutside?.lastMousedownWasOutside?r.value=!1:(i.value=!0,n.value?.focus())),v.value=null}function ae(e){r.value=!0,setTimeout(()=>{s.value=!0})}function ne(e){if(s.value=!1,!n.value?.$el.contains(e.relatedTarget)){if(H(e))return
r.value=!1}}function oe(t){null!=t&&(""!==t||e.multiple||I.value)||(V.value=[])}let re=0
function ie(){re=performance.now()}function se(e){const t=e.relatedTarget,a=u.value?.contentEl;(a?.contains(t)||!t&&performance.now()-re<10)&&(r.value=!0)}const ue=t.shallowRef(!1)
function ce(a,l=!0){if(a&&!a.props.disabled)if(e.multiple){const t=V.value.findIndex(t=>(e.valueComparator||ht)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...V.value,a]:[...V.value]
e.splice(t,1),V.value=e}else n&&(V.value=[...V.value,a])
e.clearOnSelect&&(b.value="")}else{const e=!1!==l
V.value=e?[a]:[],v.value=i.value?"":b.value??"",b.value=e&&!I.value?a.title:"",t.nextTick(()=>{B.value=!1,i.value=!0})}}return t.watch(r,(a,l)=>{a!==l&&(a?(ue.value=!0,b.value=e.multiple||I.value?"":String(V.value.at(-1)?.props.title??""),i.value=!0,t.nextTick(()=>ue.value=!1)):(e.multiple||null!=b.value||(V.value=[]),B.value=!1,!i.value&&b.value&&(v.value=b.value),b.value="",d.value=-1))}),t.watch(b,e=>{r.value&&!ue.value&&(e&&(B.value=!0),i.value=!e)}),t.watch(B,t=>{if(!e.hideSelected&&t&&V.value.length&&i.value){const e=N.value.findIndex(e=>V.value.some(t=>e.value===t.value))
...
const Ps=/^(\d{4})-(\d{1,2})(-(\d{1,2}))?([^\d]+(\d{1,2}))?(:(\d{1,2}))?(:(\d{1,2}))?$/,Rs=/(\d\d?)(:(\d\d?)|)(:(\d\d?)|)/,As=[0,31,28,31,30,31,30,31,31,30,31,30,31],Ts=[0,31,29,31,30,31,30,31,31,30,31,30,31]
function Ds(e){const t=Zs(e)
...
return e.hasTime&&a&&o&&(l=js(t),n=js(e),o=l===n),e.past=n<l,e.present=o,e.future=n>l,e}function Us(e){return e instanceof Date||"number"==typeof e&&isFinite(e)}function Ys(e,t,a){return e.hasTime!==t&&(e.hasTime=t,t||(e.hour=23,e.minute=59,e.time=Js(e))),e}function Gs(e,t,a){return e.hasTime=!0,e.hour=0,e.minute=0,eu(e,t),qs(e),a&&Ws(e,a,!0),e}function Ks(e){return e.weekday=function(e){if(e.hasDay){const t=Math.floor,a=e.day,l=(e.month+9)%12+1,n=t(e.year/100),o=e.year%100-(e.month<=2?1:0)
...
return t}(e),e}function Xs(e,t){return function(e){return e%4==0&&e%100!=0||e%400==0}(e)?Ts[t]:As[t]}function Zs(e){if(null==e)return null
...
r(e,a.now),i(e,a.now),r(e,a.today)}return t.watch(l,s),s(),n(),{times:a,parsedNow:l,updateTimes:s,setPresent:n,getNow:o,updateDay:r,updateTime:i}}({now:e.now}),n=ua(e),o=Iu(),r=t.computed(()=>"month"===e.type?Ds(zs(e.start,!0)):zs(e.start,!0)),i=t.computed(()=>{const t=r.value,a=e.end&&zs(e.end)||t,l=Hs(a)<Hs(t)?t:a
...
return!(t.hour===e.hour&&t.minute===e.minute)},intervalStyleDefault:function(e){},getTimestampAtEvent:function(e,t){const l=Zs(t),n=new fe(e.currentTarget),r=u.value,s=e,c=e,d=s.changedTouches||s.touches,v=d&&d[0]?d[0]:c,p=(he([v.clientX,v.clientY]).y-n.top)/i.value
return Gs(l,r+Math.floor(p*o.value),a.times.now)},getSlotScope:function(e){const t=Zs(e)
...
return!(!1===t||!a)&&(a.scrollTop=t,!0)},minutesToPixels:m,timeToY:f,timeDelta:g}}const Tu={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
window.addEventListener("resize",a,l),e._onResize=Object(e._onResize),e._onResize[t.instance.$.uid]={handler:a,options:l},t.modifiers?.quiet||a()},unmounted:function(e,t){if(!e._onResize?.[t.instance.$.uid])return
const{handler:a,options:l}=e._onResize[t.instance.$.uid]
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}},Du=mt({name:"VCalendarDaily",directives:{vResize:Tu},props:{color:String,shortWeekdays:{type:Boolean,default:!0},shortIntervals:{type:Boolean,default:!0},hideHeader:Boolean,..._u(),...Ru()},setup(e,{slots:a,attrs:l}){const n=t.ref(0),o=t.ref(),r=Au(e)
...
return t.createElementVNode("div",t.mergeProps({key:e.date,class:["v-calendar-daily__day",r.getRelativeClasses(e)]},n),[y(a),h(e)])})])])])])]),[[Tu,s,void 0,{quiet:!0}]])),{...r,scrollPush:n,pane:o,init:i,onResize:s,getScrollPush:u}}})
...
return t.createElementVNode("div",t.mergeProps({class:"v-calendar-category__column"},i),[a["day-body"]?.(r(n.getSlotScope(e),o))])}return It(()=>t.createVNode(Du,t.mergeProps({class:["v-calendar-daily","v-calendar-category"]},e),{...a,days:u,"day-header":i})),{...n,parsedCategories:o}}}),$u={control:"ctrl",command:"cmd",option:"alt",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright",esc:"escape",spacebar:" ",space:" ",return:"enter",del:"delete",plus:"+",slash:"/",underscore:"_",minus:"-",hyphen:"-"}
class Mu extends Error{}function zu(e){let t=0
try{const e=function(){const e=[r()]
for(;"-"===l();)n(),e.push(r())
return 1===e.length?e[0]:{type:"sequence",parts:e}}()
if(!o())throw new Mu(`Unexpected character '${l()}' at position ${t}`)
return e}catch(l){if(l instanceof Mu)return a(`Invalid hotkey combination: ${l.message}\n  ${e}\n  ${" ".repeat(t)}^`),""
throw l}function l(a=0){return t+a<e.length?e[t+a]:null}function n(){if(t>=e.length)throw new Mu("Unexpected end of input")
...
if(null==e)throw new Mu("Unexpected end of input")
const a=l(1)
if(Lu(e)&&null!=a&&!Lu(a))throw new Mu(`Unexpected separator '${e}' at position ${t}`)
const r=n()
if(Lu(r))return r
const i=[r]
for(;!o()&&!Lu(l())&&" "!==l();)i.push(n())
return function(e){const t=e.toLowerCase()
return $u[t]||t}(i.join(""))}}function Lu(e){return H(["-","/","+","_"],e)}const Ou=["ctrl","shift","alt","meta","cmd"],ju=new Set(Ou)
function Hu(e){return ju.has(e)}const Wu=Object.fromEntries(Ou.map(e=>[e,!1]))
function Uu(e,t,a){if("string"!=typeof t&&"alternate"===t.type)return t.parts.some(t=>Uu(e,t,a))
const{modifiers:l,actualKey:n}=function(e){const t="string"==typeof e?[e]:e.parts,a={...Wu}
let l
for(const e of t)Hu(e)?a[e]=!0:l=e
return{modifiers:a,actualKey:l}}(t),o=l.ctrl||!a&&(l.cmd||l.meta),r=a&&(l.cmd||l.meta)
return e.ctrlKey===o&&e.metaKey===r&&e.shiftKey===l.shift&&e.altKey===l.alt&&e.key.toLowerCase()===n?.toLowerCase()}const Yu={"credit-card":"#### - #### - #### - ####",date:"##/##/####","date-time":"##/##/#### ##:##","iso-date":"####-##-##","iso-date-time":"####-##-## ##:##",phone:"(###) ### - ####",social:"###-##-####",time:"##:##","time-with-seconds":"##:##:##"},Gu={"#":{pattern:/[0-9]/},A:{pattern:/[A-Z]/i,convert:e=>e.toUpperCase()},a:{pattern:/[a-z]/i,convert:e=>e.toLowerCase()},N:{pattern:/[0-9A-Z]/i,convert:e=>e.toUpperCase()},n:{pattern:/[0-9a-z]/i,convert:e=>e.toLowerCase()},X:{pattern:/[-!$%^&*()_+|~=`{}[\]:";'<>?,./\\ ]/}}
const Ku=mt({name:"VCalendarWeekly",props:{minWeeks:{validate:Fs,default:1},monthFormat:Function,showWeek:Boolean,color:String,shortWeekdays:{type:Boolean,default:!0},showMonthOnFirst:{type:Boolean,default:!0},shortMonths:{type:Boolean,default:!0},hideHeader:Boolean,..._u()},setup(e,{slots:a,attrs:l}){const n=Pu(e),o=wa(),r=t.computed(()=>parseInt(String(e.minWeeks))),i=t.computed(()=>{const e=r.value*n.parsedWeekdays.value.length
...
function qu(e,t=0){const a=e.map(e=>({event:e,columnCount:0,column:0,left:0,width:100}))
return a.sort((e,a)=>Math.max(t,e.event.startTimestampIdentifier)-Math.max(t,a.event.startTimestampIdentifier)||a.event.endTimestampIdentifier-e.event.endTimestampIdentifier),a}function Xu(e,t,a,l,n=!0){return n?!(e>=l||t<=a):!(e>l||t<a)}function Zu(e){e.forEach(t=>{t.visuals.forEach(t=>{t.columnCount=e.length})})}function Qu(e){return[e.startTimestampIdentifier,e.endTimestampIdentifier]}function Ju(e){return[e.startIdentifier,e.endIdentifier]}function ec(e,t){return[Math.max(t,e.startTimestampIdentifier),Math.min(t+864e5,e.endTimestampIdentifier)]}function tc(e){const t={groups:[],min:-1,max:-1,reset:()=>{t.groups=[],t.min=t.max=-1},getVisuals:(a,l,n,o=!1)=>{(a.weekday===e||o)&&t.reset()
const r=qu(l,Hs(a))
return r.forEach(e=>{const[a,l]=n?Qu(e.event):Ju(e.event)
t.groups.length>0&&!Xu(a,l,t.min,t.max,n)&&(Zu(t.groups),t.reset())
let o=function(e,t,a,l){for(let n=0;n<e.length;n++){const o=e[n]
let r=!1
if(Xu(t,a,o.start,o.end,l))for(let e=0;e<o.visuals.length;e++){const n=o.visuals[e],[i,s]=l?Qu(n.event):Ju(n.event)
if(Xu(t,a,i,s,l)){r=!0
break}}if(!r)return n}return-1}(t.groups,a,l,n);-1===o&&(o=t.groups.length,t.groups.push({start:a,end:l,visuals:[]}))
const r=t.groups[o]
r.visuals.push(e),r.start=Math.min(r.start,a),r.end=Math.max(r.end,l),e.column=o,-1===t.min?(t.min=a,t.max=l):(t.min=Math.min(t.min,a),t.max=Math.max(t.max,l))}),Zu(t.groups),n&&t.reset(),r}}
return t}const ac=100
function lc(e,t){for(const a of e){const{visual:l,parent:n}=a,o=cc(a)+1,r=n?n.visual.left:0,i=ac-r,s=Math.min(5,ac/o),u=nc(a,e),c=i/(o-a.index+1),d=i/(o-a.index+(a.sibling?1:0))*u
n&&(l.left=a.sibling?r+c:r+s),l.width=sc(a,e,t)?ac-l.left:Math.min(ac-l.left,1.7*d)}}function nc(e,t){if(!e.children.length)return 1
const a=e.index+t.length
return e.children.reduce((e,t)=>Math.min(e,t.index),a)-e.index}function oc(e,t){const a=function(e,t){const a=[]
for(const l of t)Xu(e.start,e.end,l.start,l.end)&&a.push(l.index)
return a}(e,t)
a.sort()
for(let e=0;e<a.length;e++)if(e<a[e])return e
return!1}function rc(e,t,a,l,n=!1){const o=[]
for(const n of t)n.index>=a&&n.index<=l&&Xu(e.start,e.end,n.start,n.end)&&o.push(n)
if(n&&o.length>0){const e=o.reduce((e,t)=>Math.min(e,t.index),o[0].index)
return o.filter(t=>t.index===e)}return o}function ic(e,t){let a=null
for(const l of t)Xu(e.start,e.end,l.start,l.end)&&(null===a||l.index>a.index)&&(a=l)
return a}function sc(e,t,a){for(const l of t)if(l!==e&&l.index>e.index&&Xu(e.start,dc(e.start,a),l.start,l.end))return!1
return!0}function uc(e,t){const[a,l]=ec(e.event,t)
return{parent:null,sibling:!0,index:0,visual:e,start:a,end:l,children:[]}}function cc(e){let t=e.index
for(const a of e.children){const e=cc(a)
e>t&&(t=e)}return t}function dc(e,t){const a=e%100,l=a+t
return e-a+100*Math.floor(l/60)+l%60}const vc={stack:(e,t,a)=>{const l=tc(t)
return(e,t,n,o)=>{if(!n)return l.getVisuals(e,t,n,o)
const r=Hs(e),i=qu(t,r),s=function(e,t){const a=[]
for(const l of e){const[e,n]=ec(l.event,t)
let o=!1
for(const t of a)if(Xu(e,n,t.start,t.end)){t.visuals.push(l),t.end=Math.max(t.end,n),o=!0
break}o||a.push({start:e,end:n,visuals:[l]})}return a}(i,r)
for(const e of s){const t=[]
for(const l of e.visuals){const e=uc(l,r),n=oc(e,t)
if(!1===n){const l=ic(e,t)
l&&(e.parent=l,e.sibling=Xu(e.start,e.end,l.start,dc(l.start,a)),e.index=l.index+1,l.children.push(e))}else{const[l]=rc(e,t,n-1,n-1),o=rc(e,t,n+1,n+t.length,!0)
e.children=o,e.index=n,l&&(e.parent=l,e.sibling=Xu(e.start,e.end,l.start,dc(l.start,a)),l.children.push(e))
for(const t of o){t.parent===l&&(t.parent=e)
t.index-e.index<=1&&e.sibling&&Xu(e.start,dc(e.start,a),t.start,t.end)&&(t.sibling=!0)}}t.push(e)}lc(t,a)}return i.sort((e,t)=>e.left-t.left||e.event.startTimestampIdentifier-t.event.startTimestampIdentifier),i}},column:(e,t,a)=>{const l=tc(t)
...
function pc(e,t){return t>=e.startIdentifier&&t<=e.endIdentifier}function mc(e,t,a,l){return a===e.startIdentifier||l===t.weekday&&pc(e,a)}const fc=rt({events:{type:Array,default:()=>[]},eventStart:{type:String,default:"start"},eventEnd:{type:String,default:"end"},eventTimed:{type:[String,Function],default:"timed"},eventCategory:{type:[String,Function],default:"category"},eventHeight:{type:Number,default:20},eventColor:{type:[String,Function],default:"primary"},eventTextColor:{type:[String,Function]},eventName:{type:[String,Function],default:"name"},eventOverlapThreshold:{type:[String,Number],default:60},eventOverlapMode:{type:[String,Function],default:"stack",validate:e=>e in vc||"function"==typeof e},eventMore:{type:Boolean,default:!0},eventMoreText:{type:String,default:"$vuetify.calendar.moreEvents"},eventRipple:{type:[Boolean,Object],default:null},eventMarginBottom:{type:Number,default:1}},"VCalendar-events")
function gc(e,a,l){const n=Pu(e),o=t.computed(()=>!Array.isArray(e.events)||0===e.events.length),r=t.computed(()=>"category"===e.type),i=t.computed(()=>"function"==typeof e.eventTimed?e.eventTimed:t=>!!t[e.eventTimed]),s=t.computed(()=>"function"==typeof e.eventCategory?e.eventCategory:t=>t[e.eventCategory]),u=t.computed(()=>e.events?e.events.map((t,a)=>function(e,t,a,l,n=!1,o=!1){const r=e[a],i=e[l],s=zs(r,!0),u=i?zs(i,!0):s,c=Us(r)?Ys(s,n):s,d=Us(i)?Ys(u,n):u,v=Os(c),p=Hs(c),m=Os(d),f=c.hasTime?0:2359
return{input:e,start:c,startIdentifier:v,startTimestampIdentifier:p,end:d,endIdentifier:m,endTimestampIdentifier:Hs(d)+f,allDay:!c.hasTime,index:t,category:o}}(t,a,e.eventStart||"",e.eventEnd||"",i.value(t),!!r.value&&s.value(t))):[]),c=t.computed(()=>parseInt(String(e.eventOverlapThreshold||0))),d=t.computed(()=>"function"==typeof e.eventTextColor?e.eventTextColor:()=>e.eventTextColor),v=t.computed(()=>"function"==typeof e.eventName?e.eventName:(t,a)=>t.input[e.eventName]||""),p=t.computed(()=>"function"==typeof e.eventOverlapMode?e.eventOverlapMode:vc[e.eventOverlapMode]),m=t.computed(()=>n.effectiveWeekdays.value)
...
return u.value.filter(l=>mc(l,e,t,a))}function C(e){const t=Os(e),a=m.value[0]
return u.value.filter(l=>l.allDay&&(r.value?pc(l,t):mc(l,e,t,a))&&x(l,e.category))}function E(e){return u.value.filter(t=>!t.allDay&&function(e,t,a){if(a){const l=eu(Zs(t),a[0]),n=eu(Zs(t),a[1]),o=e.startTimestampIdentifier<Hs(n),r=e.endTimestampIdentifier>Hs(l)
return o&&r}return pc(e,Os(t))}(t,e,e.intervalRange)&&x(t,e.category))}return{...n,noEvents:o,parsedEvents:u,parsedEventOverlapThreshold:c,eventTimedFunction:i,eventCategoryFunction:s,eventTextColorFunction:d,eventNameFunction:v,eventModeFunction:p,eventWeekdays:m,categoryMode:r,eventColorFunction:f,eventsRef:g,updateEventVisibility:function(){if(o.value||!e.eventMore)return
...
t&&(n=n.concat(t))}return n}}}}}const hc=ft()({name:"VCalendar",directives:{vResize:Tu},props:{modelValue:{type:[String,Number,Date],validate:Ms},categoryDays:{type:[Number,String],default:1,validate:e=>isFinite(parseInt(e))&&parseInt(e)>0},categories:{type:[Array,String],default:""},categoryText:{type:[String,Function]},maxDays:{type:Number,default:7},categoryHideDynamic:{type:Boolean},categoryShowAll:{type:Boolean},categoryForInvalid:{type:String,default:""},..._u(),...fc()},setup(e,{slots:a,attrs:l,emit:n}){const o=t.ref(),r=gc(e,a,l),i=t.ref(null),s=t.ref(null),u=t.computed(()=>parseInt(String(e.categoryDays))||1),c=t.computed(()=>Bu(e.categories,e.categoryText)),d=t.computed(()=>{const t=r.parsedValue.value
let a=null,l=e.maxDays,n=c.value,o=t,i=t
switch(e.type){case"month":a=Ku,o=Ds(t),i=Bs(t)
break
case"week":a=Du,o=r.getStartOfWeek(t),i=r.getEndOfWeek(t),l=7
break
case"day":a=Du,l=1
break
case"4day":a=Du,i=lu(Zs(i),tu,3),qs(i),l=4
break
case"custom-weekly":a=Ku,o=r.parsedStart.value||t,i=r.parsedEnd.value
break
case"custom-daily":a=Du,o=r.parsedStart.value||t,i=r.parsedEnd.value
break
...
return t.withDirectives(t.createVNode(u,t.mergeProps({ref:o,class:["v-calendar",{"v-calendar-events":!r.noEvents.value}],role:"grid"},u.filterProps(e),{start:a.date,end:i.date,maxDays:s,weekdays:r.effectiveWeekdays.value,categories:c,"onClick:date":(e,t)=>{l["onUpdate:modelValue"]&&n("update:modelValue",t.date)}}),r.getScopedSlots()),[[Tu,r.updateEventVisibility,void 0,{quiet:!0}]])}),Vo({...r,lastStart:i,lastEnd:s,parsedCategoryDays:u,renderProps:d,eventWeekdays:v,categoryMode:p,title:g,monthLongFormatter:m,monthShortFormatter:f,parsedCategories:c,checkChange:h,move:y,next:function(e=1){y(e)},prev:function(e=1){y(-e)},getCategoryList:b},o)}}),yc=rt({...it(),...xa()},"VCardActions"),bc=ft()({name:"VCardActions",props:yc(),setup:(e,{slots:a})=>(vt({VBtn:{slim:!0,variant:"text"}}),It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-actions",e.class]),style:t.normalizeStyle(e.style)},a)),{})}),Vc=rt({opacity:[Number,String],...it(),...xa()},"VCardSubtitle"),wc=ft()({name:"VCardSubtitle",props:Vc(),setup:(e,{slots:a})=>(It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-subtitle",e.class]),style:t.normalizeStyle([{"--v-card-subtitle-opacity":e.opacity},e.style])},a)),{})}),Sc=gt("v-card-title"),kc=rt({appendAvatar:String,appendIcon:_t,prependAvatar:String,prependIcon:_t,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...it(),...Al(),...xa()},"VCardItem"),xc=ft()({name:"VCardItem",props:kc(),setup:(e,{slots:a})=>(It(()=>{const l=!(!e.prependAvatar&&!e.prependIcon),n=!(!l&&!a.prepend),o=!(!e.appendAvatar&&!e.appendIcon),r=!(!o&&!a.append),i=!(null==e.title&&!a.title),s=!(null==e.subtitle&&!a.subtitle)
return t.createVNode(e.tag,{class:t.normalizeClass(["v-card-item",e.class]),style:t.normalizeStyle(e.style)},{default:()=>[n&&t.createElementVNode("div",{key:"prepend",class:"v-card-item__prepend"},[a.prepend?t.createVNode(Ja,{key:"prepend-defaults",disabled:!l,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},a.prepend):t.createElementVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Gn,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Ql,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createElementVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(Sc,{key:"title"},{default:()=>[a.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(wc,{key:"subtitle"},{default:()=>[a.subtitle?.()??t.toDisplayString(e.subtitle)]}),a.default?.()]),r&&t.createElementVNode("div",{key:"append",class:"v-card-item__append"},[a.append?t.createVNode(Ja,{key:"append-defaults",disabled:!o,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},a.append):t.createElementVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Ql,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Gn,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])]})}),{})}),Nc=rt({opacity:[Number,String],...it(),...xa()},"VCardText"),Cc=ft()({name:"VCardText",props:Nc(),setup:(e,{slots:a})=>(It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-text",e.class]),style:t.normalizeStyle([{"--v-card-text-opacity":e.opacity},e.style])},a)),{})}),Ec=rt({appendAvatar:String,appendIcon:_t,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:_t,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...hl(),...it(),...Al(),...el(),...bl(),...rn(),...Sl(),...dn(),...sl(),...fn(),...xa(),...va(),...Fl({variant:"elevated"})},"VCard"),Ic=ft()({name:"VCard",directives:{vRipple:An},props:Ec(),setup(e,{attrs:a,slots:l}){const{themeClasses:n}=Va(e),{borderClasses:o}=yl(e),{colorClasses:r,colorStyles:i,variantClasses:s}=$l(e),{densityClasses:u}=Tl(e),{dimensionStyles:c}=tl(e),{elevationClasses:d}=Vl(e),{loaderClasses:v}=sn(e),{locationStyles:p}=kl(e),{positionClasses:m}=vn(e),{roundedClasses:g}=ul(e),h=mn(e,a),y=t.shallowRef(void 0)
...
return t.withDirectives(t.createVNode(V,t.mergeProps(h.linkProps,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b},n.value,o.value,r.value,u.value,d.value,v.value,m.value,g.value,s.value,e.class],style:[i.value,c.value,p.value,{"--v-card-height":f(e.height)},e.style],onClick:b&&h.navigate.value,tabindex:e.disabled?-1:void 0}),{default:()=>[C&&t.createElementVNode("div",{key:"image",class:"v-card__image"},[l.image?t.createVNode(Ja,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},l.image):t.createVNode(gl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(un,{name:"v-card",active:!!e.loading,color:y.value},{default:l.loader}),E&&t.createVNode(xc,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:l.item,prepend:l.prepend,title:l.title,subtitle:l.subtitle,append:l.append}),I&&t.createVNode(Cc,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.(),l.actions&&t.createVNode(bc,null,{default:l.actions}),Bl(b,"v-card")]}),[[An,b&&e.ripple]])}),{}}})
function _c(e,t){const a=e.changedTouches[0]
...
e.offsetX=a-t,e.offsetY=n-l,Math.abs(e.offsetY)<.5*Math.abs(e.offsetX)&&(e.left&&a<t-16&&e.left(e),e.right&&a>t+16&&e.right(e)),Math.abs(e.offsetX)<.5*Math.abs(e.offsetY)&&(e.up&&n<l-16&&e.up(e),e.down&&n>l+16&&e.down(e))})(t)}const Pc={mounted:function(e,t){const a=t.value,l=a?.parent?e.parentElement:e,n=a?.options??{passive:!0},o=t.instance?.$.uid
...
t.touchstartX=a.clientX,t.touchstartY=a.clientY,t.start?.({originalEvent:e,...t})}(e,t),touchend:e=>_c(e,t),touchmove:e=>function(e,t){const a=e.changedTouches[0]
...
V(n).forEach(e=>{a.removeEventListener(e,n[e])}),delete a._touchHandlers[l]}},Rc=Symbol.for("vuetify:v-window"),Ac=Symbol.for("vuetify:v-window-group"),Tc=rt({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},verticalArrows:[Boolean,String],touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},crossfade:Boolean,transitionDuration:Number,...it(),...xa(),...va()},"VWindow"),Dc=ft()({name:"VWindow",directives:{vTouch:Pc},props:Tc(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{themeClasses:l}=Va(e),{isRtl:n}=ca(),{t:r}=sa(),i=Hl(e,Ac),s=t.ref(),u=t.computed(()=>n.value?!e.reverse:e.reverse),d=t.shallowRef(!1),v=t.computed(()=>{if(e.crossfade)return"v-window-crossfade-transition"
...
l.scrollTop!==n.top&&l.scrollTo({...n,behavior:"instant"})})})},{flush:"sync"}),t.provide(Rc,{transition:v,isReversed:d,transitionCount:p,transitionHeight:m,rootRef:s})
...
const Hc={h:0,s:0,v:0,a:1},Wc={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)}),localeKey:"redInput"},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)}),localeKey:"greenInput"},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)}),localeKey:"blueInput"},{label:"A",max:1,step:.01,getValue:({a:e})=>null!=e?Math.round(100*e)/100:1,getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:We,from:Ye},Uc={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)}),localeKey:"hueInput"},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)}),localeKey:"saturationInput"},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)}),localeKey:"lightnessInput"},{label:"A",max:1,step:.01,getValue:({a:e})=>null!=e?Math.round(100*e)/100:1,getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:Ge,from:Ke},Yc={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t,localeKey:"hexaInput"}],to:et,from:function(e){return Ye(Je(e))}},Gc={rgb:{...Wc,inputs:Wc.inputs?.slice(0,3)},rgba:Wc,hsl:{...Uc,inputs:Uc.inputs.slice(0,3)},hsla:Uc,hex:{...Yc,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t,localeKey:"hexInput"}]},hexa:Yc},Kc=({label:e,...a})=>t.createElementVNode("div",{class:"v-color-picker-edit__input"},[t.createElementVNode("input",t.normalizeProps(t.guardReactiveProps(a)),null),t.createElementVNode("span",null,[e])]),qc=mt({name:"VColorPickerEdit",props:rt({color:Object,disabled:Boolean,readonly:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Gc).includes(e)},modes:{type:Array,default:()=>Object.keys(Gc),validator:e=>Array.isArray(e)&&e.every(e=>Object.keys(Gc).includes(e))},...it()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,{emit:a}){const{t:l}=sa(),n=t.computed(()=>e.modes.map(e=>({...Gc[e],name:e}))),o=t.computed(()=>{const t=n.value.find(t=>t.name===e.mode)
if(!t)return[]
...
l&&a("update:color",t.from(r(o??t.to(Hc),l.value)))}}))})
return It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-edit",e.class]),style:t.normalizeStyle(e.style)},[o.value?.map(e=>t.createVNode(Kc,e,null)),n.value.length>1&&t.createVNode(Dn,{icon:"$unfold",size:"x-small",variant:"plain","aria-label":l("$vuetify.colorPicker.ariaLabel.changeFormat"),onClick:()=>{const t=n.value.findIndex(t=>t.name===e.mode)
a("update:mode",n.value[(t+1)%n.value.length].name)}},null)])),{}}}),Xc=Symbol.for("vuetify:v-slider")
function Zc(e,t,a){const l="vertical"===a,n=t.getBoundingClientRect(),o="touches"in e?e.touches[0]:e
return l?o.clientY-(n.top+n.height/2):o.clientX-(n.left+n.width/2)}const Qc=rt({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e||"hover"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,noKeyboard:Boolean,...sl(),...bl({elevation:1}),ripple:{type:Boolean,default:!0}},"Slider"),Jc=e=>{const a=t.computed(()=>parseFloat(e.min)),l=t.computed(()=>parseFloat(e.max)),n=t.computed(()=>Number(e.step)>0?parseFloat(e.step):0),o=t.computed(()=>Math.max(T(n.value),T(a.value)))
...
P.value=i(a),P.value&&(E.value=!0,P.value.contains(a.target)?I.value=Zc(a,P.value,e.direction):(I.value=0,null!=o&&n({value:o})),null!=o&&l({value:o}),t.nextTick(()=>P.value?.focus()))},B={passive:!0,capture:!0}
...
return t.provide(Xc,H),H},td=rt({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,noKeyboard:Boolean,...it()},"VSliderThumb"),ad=ft()({name:"VSliderThumb",directives:{vRipple:An},props:td(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a,emit:l}){const n=t.inject(Xc),{isRtl:o,rtlClasses:r}=ca()
...
return t.createVNode(ho,t.mergeProps({ref:r,class:["v-slider",{"v-slider--has-labels":!!a["tick-label"]||y.value,"v-slider--focused":S.value,"v-slider--pressed":v.value,"v-slider--disabled":b.value},i.value,e.class],style:e.style},l,s,{focused:S.value}),{...a,prepend:h?l=>t.createElementVNode(t.Fragment,null,[a.label?.(l)??(e.label?t.createVNode(qn,{id:l.id.value,class:"v-slider__label",text:e.label},null):void 0),a.prepend?.(l)]):void 0,default:({id:l,messagesId:n})=>t.createElementVNode("div",{class:"v-slider__container",onMousedown:V.value?void 0:m,onTouchstartPassive:V.value?void 0:f},[t.createElementVNode("input",{id:l.value,name:e.name||l.value,disabled:b.value,readonly:V.value,tabindex:"-1",value:u.value},null),t.createVNode(nd,{ref:g,start:0,stop:N.value},{"tick-label":a["tick-label"]}),t.createVNode(ad,t.mergeProps({ref:o,"aria-describedby":n.value,focused:S.value,noKeyboard:w.value,min:c.value,max:d.value,modelValue:u.value,"onUpdate:modelValue":e=>u.value=e,position:N.value,elevation:e.elevation,onFocus:k,onBlur:x,ripple:e.ripple,name:e.name},p),{"thumb-label":a["thumb-label"]})])})}),Vo({focus:()=>o.value?.$el.focus()},r)}}),id=rt({color:{type:Object},disabled:Boolean,readonly:Boolean,hideAlpha:Boolean,hideEyeDropper:Boolean,eyeDropperIcon:{type:_t,default:"$eyeDropper"},...it()},"VColorPickerPreview"),sd=mt({name:"VColorPickerPreview",props:id(),emits:{"update:color":e=>!0},setup(e,{emit:a}){const{t:l}=sa(),n=new AbortController,o=t.toRef(()=>!e.disabled&&!e.readonly)
async function r(){if(!s||!o.value)return
const t=new window.EyeDropper
try{const l=Ye(He((await t.open({signal:n.signal})).sRGBHex))
a("update:color",{...e.color??Hc,...l})}catch(e){}}return t.onUnmounted(()=>n.abort()),It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class]),style:t.normalizeStyle(e.style)},[s&&!e.hideEyeDropper&&t.createElementVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Dn,{"aria-label":l("$vuetify.colorPicker.ariaLabel.eyedropper"),density:"comfortable",disabled:e.disabled,readonly:e.readonly,icon:e.eyeDropperIcon,variant:"plain",onClick:r},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__dot"},[t.createElementVNode("div",{style:{background:Xe(e.color??Hc)}},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(rd,{class:"v-color-picker-preview__track v-color-picker-preview__hue","aria-label":l("$vuetify.colorPicker.ariaLabel.hueSlider"),modelValue:e.color?.h,"onUpdate:modelValue":t=>a("update:color",{...e.color??Hc,h:t}),step:1,min:0,max:360,disabled:e.disabled,readonly:e.readonly,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(rd,{class:"v-color-picker-preview__track v-color-picker-preview__alpha","aria-label":l("$vuetify.colorPicker.ariaLabel.alphaSlider"),modelValue:e.color?.a??1,"onUpdate:modelValue":t=>a("update:color",{...e.color??Hc,a:t}),step:.01,min:0,max:1,disabled:e.disabled,readonly:e.readonly,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])])),{}}})
var ud={red:{base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"},pink:{base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"},purple:{base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"},deepPurple:{base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"},indigo:{base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"},blue:{base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"},lightBlue:{base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"},cyan:{base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"},teal:{base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"},green:{base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"},lightGreen:{base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"},lime:{base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"},yellow:{base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"},amber:{base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"},orange:{base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"},deepOrange:{base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"},brown:{base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"},blueGrey:{base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"},grey:{base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"},shades:{black:"#000000",white:"#ffffff",transparent:"#ffffff00"}}
const cd=rt({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map(t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]})}(ud)},disabled:Boolean,readonly:Boolean,color:Object,maxHeight:[Number,String],...it()},"VColorPickerSwatches")
const dd=mt({name:"VColorPickerSwatches",props:cd(),emits:{"update:color":e=>!0},setup(e,{emit:a}){const l=t.toRef(()=>!e.disabled&&!e.readonly)
...
return t.onBeforeMount(()=>{e.modes.includes(n.value)||(n.value=e.modes[0])}),vt({VSlider:{color:null,trackColor:null,trackFillColor:null}}),It(()=>{const a=md.filterProps(e)
return t.createVNode(md,t.mergeProps(a,{class:["v-color-picker",s.value,e.class],style:[{"--v-color-picker-color-hsv":Xe({...i.value??Hc,a:1})},e.style]}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[!e.hideCanvas&&t.createVNode(jc,{key:"canvas",color:i.value,"onUpdate:color":c,disabled:e.disabled,readonly:e.readonly,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createElementVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(sd,{key:"preview",color:i.value,"onUpdate:color":c,hideAlpha:!n.value.endsWith("a"),disabled:e.disabled,readonly:e.readonly,hideEyeDropper:e.hideEyeDropper,eyeDropperIcon:e.eyeDropperIcon},null),!e.hideInputs&&t.createVNode(qc,{key:"edit",modes:e.modes,mode:n.value,"onUpdate:mode":e=>n.value=e,color:i.value,"onUpdate:color":c,disabled:e.disabled,readonly:e.readonly},null)]),e.showSwatches&&t.createVNode(dd,{key:"swatches",color:i.value,"onUpdate:color":c,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled,readonly:e.readonly},null)])})}),{}}}),gd=rt({alwaysFilter:Boolean,autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...ts({filterKeys:["title"]}),...rs({hideNoData:!0,returnObject:!0}),...x(ji({modelValue:null,role:"combobox"}),["validationValue","dirty"])},"VCombobox"),hd=ft()({name:"VCombobox",props:gd(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,{emit:a,slots:l}){const{t:n}=sa(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),c=t.ref(),d=t.ref(),v=t.shallowRef(-1)
let p=!1
...
return e.multiple?a:a[0]??null}),w=vo(e),S=t.toRef(()=>e.closableChips&&!w.isReadonly.value&&!w.isDisabled.value),k=t.computed(()=>!(!e.chips&&!l.chip)),x=t.computed(()=>k.value||!!l.selection),N=t.shallowRef(e.multiple||x.value?"":V.value[0]?.title??""),C=t.shallowRef(null),E=t.computed({get:()=>N.value,set:async a=>{if(N.value=a??"",null===a||""===a&&!e.multiple&&!x.value?V.value=[]:e.multiple||x.value||(V.value=[Ir(e,a)],t.nextTick(()=>d.value?.scrollToIndex(0))),a&&e.multiple&&e.delimiters?.length){const e=se(a)
e.length>1&&(ue(e),N.value="")}a||(v.value=-1),s.value=!a}}),_=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?V.value.length:E.value.length),{filteredItems:R,getMatches:A}=as(e,m,()=>C.value??(e.alwaysFilter||!s.value?E.value:"")),T=t.computed(()=>e.hideSelected&&null===C.value?R.value.filter(e=>!V.value.some(t=>t.value===e.value)):R.value),D=t.computed(()=>e.hideNoData&&!T.value.length||w.isReadonly.value||w.isDisabled.value),B=Zt(e,"menu"),F=t.computed({get:()=>B.value,set:e=>{B.value&&!e&&c.value?.ΨopenChildren.size||e&&D.value||(B.value=e)}}),{menuId:$,ariaExpanded:M,ariaControls:z}=os(0,F)
...
const L=t.computed(()=>V.value.map(e=>e.value)),O=t.computed(()=>T.value.find(e=>"item"===e.type&&!e.props.disabled)),j=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&E.value===O.value?.title)&&T.value.length>0&&!s.value&&!u.value),H=t.ref(),W=t.ref(),U=t.ref(),Y=Zi(H,r),G=Xi(F,()=>c.value?.contentEl,()=>r.value?.controlRef),{onTabKeydown:K}=Qi({groups:[{type:"element",contentRef:W},{type:"list",contentRef:H,displayItemsCount:()=>T.value.length},{type:"element",contentRef:U}],onLeave:()=>{F.value=!1,r.value?.focus()}})
function q(a){p=!0,t.nextTick(()=>p=!1),e.openOnClear&&(F.value=!0)}function X(){D.value||(F.value=!0)}function Z(e){D.value||(i.value&&(e.preventDefault(),e.stopPropagation()),F.value=!F.value)}function J(e){"Tab"===e.key&&K(e),H.value?.$el.contains(e.target)&&(le(e)||"Backspace"===e.key)&&r.value?.focus()}function te(t){if(function(e){return e.isComposing&&I.includes(e.key)}(t)||w.isReadonly.value)return
const a=r.value?.selectionStart,l=V.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(F.value=!0),["Escape"].includes(t.key)&&(F.value=!1),j.value&&["Enter","Tab"].includes(t.key)&&O.value&&!V.value.some(({value:e})=>e===O.value.value)&&ie(O.value),"ArrowDown"===t.key&&j.value&&H.value?.focus("next"),"Enter"===t.key&&E.value&&(ie(Ir(e,E.value),!0,!0),x.value&&(N.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&x.value&&V.value.length>0&&!E.value)return ie(V.value[0],!1)
if(~v.value){t.preventDefault()
const e=v.value
ie(V.value[v.value],!1),v.value=e>=l-1?l-2:e}else"Backspace"!==t.key||E.value||(v.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(v.value<0&&a&&a>0)return
...
const e=v.value+1
V.value[e]?v.value=e:(v.value=-1,r.value?.setSelectionRange(0,0))}else~v.value&&le(t)&&(v.value=-1)}function ae(t){const a=se(t?.clipboardData?.getData("Text")??"")
a.length>1&&e.multiple&&(t.preventDefault(),ue(a))}function ne(){e.eager&&d.value?.calculateVisibleItems()}function re(){i.value&&(c.value?.contentEl?._clickOutside?.lastMousedownWasOutside?i.value=!1:r.value?.focus()),s.value=!0,C.value=null}function ie(a,l=!0,n=!1){if(a&&!a.props.disabled)if(e.multiple){const t=V.value.findIndex(t=>(e.valueComparator||ht)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...V.value,a]:[...V.value]
e.splice(t,1),V.value=e}else n&&(V.value=[...V.value,a])
e.clearOnSelect&&(E.value="")}else{const o=!1!==l
V.value=o?[a]:[],s.value&&!e.alwaysFilter||!N.value||(C.value=N.value),N.value=o&&!x.value?a.title:"",t.nextTick(()=>{F.value=n,s.value=!0})}}function se(t){const a=["\n",...e.delimiters??[]].map(oe).join("|")
return t.split(new RegExp(`(?:${a})+`))}async function ue(a){for(let l of a)l=l.trim(),l&&(ie(Ir(e,l)),await t.nextTick())}function ce(e){i.value=!0,setTimeout(()=>{u.value=!0})}function de(e){if(u.value=!1,!r.value?.$el.contains(e.relatedTarget)){if(G(e))return
i.value=!1}}let ve=0
function pe(){ve=performance.now()}function me(e){const t=e.relatedTarget,a=c.value?.contentEl;(a?.contains(t)||!t&&performance.now()-ve<10)&&(i.value=!0)}return t.watch(i,(t,a)=>{if(!t&&t!==a&&(v.value=-1,F.value=!1,E.value)){if(e.multiple)return void ie(Ir(e,E.value))
if(!x.value)return
V.value.some(({title:e})=>e===E.value)?N.value="":ie(Ir(e,E.value))}}),t.watch(F,t=>{if(!e.hideSelected&&t&&V.value.length&&s.value){const t=T.value.findIndex(t=>V.value.some(a=>(e.valueComparator||ht)(a.value,t.value)))
...
return t.provide(wd,r),r}function kd(){const e=t.inject(wd)
if(!e)throw new Error("foo")
return e}const xd=rt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Nd=Symbol.for("vuetify:data-table-group")
function Cd(e){return{groupBy:Zt(e,"groupBy")}}function Ed(e){const{disableSort:a,groupBy:l,sortBy:n}=e,o=t.ref(new Set)
...
return t.provide(Nd,i),i}function Id(){const e=t.inject(Nd)
if(!e)throw new Error("Missing group!")
return e}function _d(e,t,a=0,l="root"){if(!t.length)return[]
...
o.push({depth:a,id:s,key:i,value:n,items:r.length?_d(e,r,a+1,s):e,type:"group"})}),o}function Pd(e,t,a){const l=[]
for(const n of e)"type"in n&&"group"===n.type?(null!=n.value&&l.push(n),(t.has(n.id)||null==n.value)&&(l.push(...Pd(n.items,t,a)),a&&l.push({...n,type:"group-summary"}))):l.push(n)
return l}function Rd(e,a,l,n){const o=t.computed(()=>a.value.length?_d(t.toValue(e),a.value.map(e=>e.key)):[]),r=t.computed(()=>a.value.length?Pd(o.value,l.value,t.toValue(n)):t.toValue(e))
return{groups:o,flatItems:r}}function Ad({page:e,itemsPerPage:a,sortBy:l,groupBy:n,search:o}){const r=st("VDataTable")
let i=null
t.watch(()=>({page:e.value,itemsPerPage:a.value,sortBy:l.value,groupBy:n.value,search:o.value}),t=>{ht(i,t)||(i&&i.search!==t.search&&(e.value=1),r.emit("update:options",t),i=t)},{deep:!0,immediate:!0})}const Td=rt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10},pageBy:{type:String,default:"any"}},"DataTable-paginate"),Dd=Symbol.for("vuetify:data-table-pagination")
function Bd(e){return{page:Zt(e,"page",void 0,e=>Number(e??1)),itemsPerPage:Zt(e,"itemsPerPage",void 0,e=>Number(e??10))}}function Fd(e){const{page:a,itemsPerPage:l,itemsLength:n}=e,o=t.computed(()=>-1===l.value?0:l.value*(a.value-1)),r=t.computed(()=>-1===l.value?n.value:Math.min(n.value,o.value+l.value)),i=t.computed(()=>-1===l.value||0===n.value?1:Math.ceil(n.value/l.value))
...
return t.provide(Dd,s),s}function $d(e){const a=st("usePaginatedItems"),{items:l,startIndex:n,stopIndex:o,itemsPerPage:r}=e,i=t.computed(()=>r.value<=0?t.toValue(l):t.toValue(l).slice(n.value,o.value))
return t.watch(i,e=>{a.emit("update:currentItems",e)},{immediate:!0}),{paginatedItems:i}}const Md={showSelectAll:!1,allSelected:()=>[],select:({items:e,value:t})=>new Set(t?[e[0]?.value]:[]),selectAll:({selected:e})=>e},zd={showSelectAll:!0,allSelected:({currentPage:e})=>e,select:({items:e,value:t,selected:a})=>{for(const l of e)t?a.add(l.value):a.delete(l.value)
return a},selectAll:({value:e,currentPage:t,selected:a})=>zd.select({items:t,value:e,selected:a})},Ld={showSelectAll:!0,allSelected:({allItems:e})=>e,select:({items:e,value:t,selected:a})=>{for(const l of e)t?a.add(l.value):a.delete(l.value)
return a},selectAll:({value:e,allItems:t})=>new Set(e?t.map(e=>e.value):[])},Od=rt({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:Function},"DataTable-select"),jd=Symbol.for("vuetify:data-table-selection")
function Hd(e,{allItems:a,currentPage:l}){const n=Zt(e,"modelValue",e.modelValue,t=>{const l=e.valueComparator
...
switch(e.selectStrategy){case"single":return Md
case"all":return Ld
default:return zd}}),s=t.shallowRef(null)
...
return t.provide(jd,p),p}function Wd(){const e=t.inject(jd)
if(!e)throw new Error("Missing selection!")
return e}const Ud=rt({initialSortOrder:{type:String,default:"asc",validator:e=>!e||["asc","desc"].includes(e)},sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:{type:[Boolean,Object],default:!1},mustSort:Boolean},"DataTable-sort"),Yd=Symbol.for("vuetify:data-table-sort")
function Gd(e){const a=t.toRef(()=>e.initialSortOrder),l=Zt(e,"sortBy"),n=t.toRef(()=>e.mustSort)
return{initialSortOrder:a,sortBy:l,multiSort:t.toRef(()=>e.multiSort),mustSort:n}}function Kd(e){const{initialSortOrder:a,sortBy:l,mustSort:n,multiSort:o,page:r}=e
...
return t.provide(Yd,i),i}function qd(){const e=t.inject(Yd)
if(!e)throw new Error("Missing sort!")
return e}function Xd(e,a,l,n){const o=sa(),r=t.computed(()=>l.value.length?function(e,t,a,l){const n=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),o=e.map(e=>[e,l?.transform?l.transform(e):e])
...
return{sortedItems:r}}const Zd=rt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function Qd(e,t){return{type:"item",value:e.returnObject?t:p(t,e.itemValue),selectable:p(t,e.itemSelectable,!0),raw:t}}function Jd(e){const a=t.computed(()=>function(e,t){const a=[]
for(const l of t)a.push(Qd(e,l))
return a}(e,e.items))
return{items:a}}const ev=rt({search:String,loading:Boolean,itemsLength:[Number,String],...it(),...Zd(),...Od(),...Ud(),...Td({itemsPerPage:5}),...Vd(),...xd(),...ts(),...xa(),...cl({transition:{component:za,hideOnLeave:!0}})},"VDataIterator"),tv=ft()({name:"VDataIterator",props:ev(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,{slots:a}){const l=Zt(e,"groupBy"),n=t.toRef(()=>e.search),{items:o}=Jd(e),{filteredItems:r}=as(e,o,n,{transform:e=>e.raw}),{initialSortOrder:i,sortBy:s,multiSort:u,mustSort:c}=Gd(e),{page:d,itemsPerPage:v}=Bd(e),{toggleSort:p}=Kd({initialSortOrder:i,sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:m,opened:f,extractRows:g,isGroupOpen:h,toggleGroup:y}=Ed({groupBy:l,sortBy:s}),{sortedItems:b}=Xd(e,r,m,{transform:e=>e.raw}),{flatItems:V}=Rd(b,l,f,!1),w=t.toRef(()=>!Z(e.itemsLength)),S=t.toRef(()=>w.value?Number(e.itemsLength):V.value.length),{startIndex:k,stopIndex:x,pageCount:N,prevPage:C,nextPage:E,setItemsPerPage:I,setPage:_}=Fd({page:d,itemsPerPage:v,itemsLength:S}),P=t.shallowRef([]),R=t.computed(()=>w.value?V.value:P.value)
Xt(()=>!w.value,()=>{const{paginatedItems:e}=$d({items:V,startIndex:k,stopIndex:x,itemsPerPage:v})
t.watchEffect(()=>{P.value=e.value})})
const A=t.computed(()=>g(R.value)),{isSelected:T,select:D,selectAll:B,toggleSelect:F}=Hd(e,{allItems:o,currentPage:A}),{isExpanded:$,toggleExpand:M}=Sd(e)
Ad({page:d,itemsPerPage:v,sortBy:s,groupBy:l,search:n})
...
return It(()=>{const v=lv.filterProps(e)
return t.createElementVNode("div",{class:"v-data-table-footer"},[a.prepend?.(),t.createElementVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createElementVNode("span",null,[l(e.itemsPerPageText)]),t.createVNode(ss,{items:d.value,itemColor:e.color,modelValue:u.value,"onUpdate:modelValue":e=>c(Number(e)),density:"compact",variant:"outlined","aria-label":l(e.itemsPerPageText),hideDetails:!0},null)]),t.createElementVNode("div",{class:"v-data-table-footer__info"},[t.createElementVNode("div",null,[l(e.pageText,s.value?r.value+1:0,i.value,s.value)])]),t.createElementVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(lv,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,density:"comfortable",firstAriaLabel:e.firstPageLabel,lastAriaLabel:e.lastPageLabel,length:o.value,nextAriaLabel:e.nextPageLabel,previousAriaLabel:e.prevPageLabel,rounded:!0,showFirstLastPage:!0,totalVisible:e.showCurrentPage?1:0,variant:"plain"},x(v,["color"])),null)])])}),{}}}),rv=(iv={align:{type:String,default:"start"},fixed:{type:[Boolean,String],default:!1},fixedOffset:[Number,String],fixedEndOffset:[Number,String],height:[Number,String],lastFixed:Boolean,firstFixedEnd:Boolean,noPadding:Boolean,indent:[Number,String],empty:Boolean,tag:String,width:[Number,String],maxWidth:[Number,String],nowrap:Boolean},sv=(e,{slots:a})=>{const l=e.tag??"td",n="string"==typeof e.fixed?e.fixed:e.fixed?"start":"none"
return t.createVNode(l,{class:t.normalizeClass(["v-data-table__td",{"v-data-table-column--fixed":"start"===n,"v-data-table-column--fixed-end":"end"===n,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--first-fixed-end":e.firstFixedEnd,"v-data-table-column--no-padding":e.noPadding,"v-data-table-column--nowrap":e.nowrap,"v-data-table-column--empty":e.empty},`v-data-table-column--align-${e.align}`]),style:{height:f(e.height),width:f(e.width),maxWidth:f(e.maxWidth),left:"start"===n?f(e.fixedOffset||null):void 0,right:"end"===n?f(e.fixedEndOffset||null):void 0,paddingInlineStart:e.indent?f(e.indent):void 0}},{default:()=>[a.default?.()]})},sv.props=iv,sv)
var iv,sv
const uv=rt({headers:Array},"DataTable-header"),cv=Symbol.for("vuetify:data-table-headers"),dv={title:"",sortable:!1},vv={...dv,width:48}
function pv(e,t=[]){if(e.children)for(const a of e.children)pv(a,t)
else t.push(e)
return t}function mv(e,t=new Set){for(const a of e)a.key&&t.add(a.key),a.children&&mv(a.children,t)
return t}function fv(e){if(e.key)return"data-table-group"===e.key?dv:["data-table-expand","data-table-select"].includes(e.key)?vv:void 0}function gv(e,t=0){return e.children?Math.max(t,...e.children.map(e=>gv(e,t+1))):t}function hv(e,t=0){if(!e)return t
...
return t}function yv(e,t=0){if(!e)return t
if(e.children){e.fixedEndOffset=t
for(const a of e.children)t=yv(a,t)}else"end"===e.fixed&&(e.fixedEndOffset=t,t+=parseFloat(e.width||"0")||0)
return t}function bv(e,t){const a=[]
let l=0
...
const o=[]
let r=1
for(;e>0;){const{element:a,priority:i}=n.dequeue(),s=t-l-gv(a)
if(o.push({...a,rowspan:s??1,colspan:a.children?pv(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+2)
n.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(o)}return{columns:e.map(e=>pv(e)).flat(),headers:a}}function Vv(e){const t=[]
for(const a of e){const e={...fv(a),...a},l=e.key??("string"==typeof e.value?e.value:null),n=e.value??l??null,o={...e,key:l,value:n,sortable:e.sortable??(null!=e.key||!!e.sort),children:e.children?Vv(e.children):void 0}
t.push(o)}return t}function wv(e,a){const n=t.ref([]),o=t.ref([]),r=t.ref({}),i=t.ref({}),s=t.ref({})
t.watchEffect(()=>{const u=(e.headers||Object.keys(e.items[0]??{}).map(e=>({key:e,title:t.capitalize(e)}))).slice(),c=mv(u)
...
let o=0
for(let t=e.length-1;t>=0;t--)o=yv(e[t],o)}(d)
const v=Math.max(...d.map(e=>gv(e)))+1,p=bv(d,v)
...
return t.provide(cv,u),u}function Sv(){const e=t.inject(cv)
if(!e)throw new Error("Missing headers!")
return e}const kv=rt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,initialSortOrder:String,sortIcon:{type:_t},sortAscIcon:{type:_t,default:"$sortAsc"},sortDescIcon:{type:_t,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Al(),...Po(),...rn()},"VDataTableHeaders"),xv=ft()({name:"VDataTableHeaders",props:kv(),setup(e,{slots:a}){const{t:l}=sa(),{toggleSort:n,sortBy:o,isSorted:r}=qd(),{someSelected:i,allSelected:s,selectAll:u,showSelectAll:c}=Wd(),{columns:d,headers:v}=Sv(),{loaderClasses:p}=sn(e)
...
return a["data-table-group"]?.({item:e.item,count:c.value.length,props:{icon:o,onClick:r}})??t.createVNode(rv,{class:"v-data-table-group-header-row__column",colspan:d.value},{default:()=>[t.createVNode(Dn,{size:"small",variant:"text",icon:o,onClick:r},null),t.createElementVNode("span",null,[e.item.value]),t.createElementVNode("span",null,[t.createTextVNode("("),c.value.length,t.createTextVNode(")")])]})}if("data-table-select"===o.key){const l=c.value.filter(e=>e.selectable),n=l.length>0&&r(l),o=i(l)&&!n,u=e=>s(l,e)
return a["data-table-select"]?.({props:{modelValue:n,indeterminate:o,"onUpdate:modelValue":u}})??t.createVNode(rv,{class:"v-data-table__td--select-row",noPadding:!0},{default:()=>[t.createVNode(lo,{density:e.density,disabled:0===l.length,modelValue:n,indeterminate:o,"onUpdate:modelValue":u},null)]})}return""})])}}),Ev=rt({color:String,index:Number,item:Object,cellProps:[Object,Function],collapseIcon:{type:_t,default:"$collapse"},expandIcon:{type:_t,default:"$expand"},onClick:U(),onContextmenu:U(),onDblclick:U(),...Al(),...Po()},"VDataTableRow"),Iv=ft()({name:"VDataTableRow",props:Ev(),setup(e,{slots:a}){const{displayClasses:l,mobile:n}=Ro(e,"v-data-table__tr"),{isSelected:o,toggleSelect:r,someSelected:i,allSelected:s,selectAll:u}=Wd(),{isExpanded:c,toggleExpand:d}=kd(),{toggleSort:p,sortBy:m,isSorted:f}=qd(),{columns:g}=Sv()
...
return n.value?t.createElementVNode(t.Fragment,null,[t.createElementVNode("div",{class:"v-data-table__td-title"},[a[b]?.(w)??l.title]),t.createElementVNode("div",{class:"v-data-table__td-value"},[a[y]?.(V)??i])]):i}})})]))}}),_v=rt({color:String,loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...S(Ev(),["collapseIcon","expandIcon","density"]),...S(Nv(),["groupCollapseIcon","groupExpandIcon","density"]),...Po()},"VDataTableRows"),Pv=ft()({name:"VDataTableRows",inheritAttrs:!1,props:_v(),setup(e,{attrs:a,slots:l}){const{columns:n}=Sv(),{expandOnClick:o,toggleExpand:r,isExpanded:i}=kd(),{isSelected:s,toggleSelect:u}=Wd(),{toggleGroup:c,isGroupOpen:d}=Id(),{t:v}=sa(),{mobile:p}=Ro(e)
...
return l["group-header"]?l["group-header"](e):t.createVNode(Cv,t.mergeProps({key:`group-header_${v.id}`,item:v},kt(a,":groupHeader",()=>e),m),l)}if("group-summary"===v.type){const e={index:f,item:v,columns:n.value,toggleGroup:c}
...
return t.createElementVNode(t.Fragment,{key:h.props.key},[l.item?l.item(h):t.createVNode(Iv,h.props,l),i(v)&&l["expanded-row"]?.(g)])})]):t.createElementVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createElementVNode("td",{colspan:n.value.length},[l["no-data"]?.()??v(e.noDataText)])]):t.createElementVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createElementVNode("td",{colspan:n.value.length},[l.loading?.()??v(e.loadingText)])])}),{}}}),Rv=rt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,striped:{type:String,default:null,validator:e=>["even","odd"].includes(e)},...it(),...Al(),...xa(),...va()},"VTable"),Av=ft()({name:"VTable",props:Rv(),setup(e,{slots:a,emit:l}){const{themeClasses:n}=Va(e),{densityClasses:o}=Tl(e)
...
function Dv(e,t,a){return t.map((t,l)=>function(e,t,a,l){const n=e.returnObject?t:p(t,e.itemValue),o=p(t,e.itemSelectable,!0),r=l.reduce((e,a)=>(null!=a.key&&(e[a.key]=p(t,a.value)),e),{})
return{type:"item",key:e.returnObject?p(t,e.itemValue):n,index:a,value:n,selectable:o,columns:r,raw:t}}(e,t,l,a))}function Bv(e,a){return{items:t.computed(()=>Dv(e,e.items,a.value))}}const Fv=rt({..._v(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...Vd(),...xd(),...uv(),...Tv(),...Od(),...Ud(),...x(kv(),["multiSort","initialSortOrder"]),...Rv()},"DataTable"),$v=rt({...Td(),...Fv(),...ts(),...nv()},"VDataTable"),Mv=ft()({name:"VDataTable",props:$v(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,{attrs:a,slots:l}){const{groupBy:n}=Cd(e),{initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}=Gd(e),{page:u,itemsPerPage:c}=Bd(e),{disableSort:d}=t.toRefs(e),{columns:v,headers:p,sortFunctions:m,sortRawFunctions:f,filterFunctions:g}=wv(e,{groupBy:n,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:h}=Bv(e,v),y=t.toRef(()=>e.search),{filteredItems:b}=as(e,h,y,{transform:e=>e.columns,customKeyFilter:g}),{toggleSort:V}=Kd({initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:N,toggleGroup:C}=Ed({groupBy:n,sortBy:r,disableSort:d}),{sortedItems:E}=Xd(e,b,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:m,sortRawFunctions:f}),I=t.computed(()=>"auto"===e.pageBy?e.groupBy.length?"group":"item":e.pageBy),{pageCount:_,setItemsPerPage:P,prevPage:R,nextPage:A,setPage:T,paginatedItems:D}=function(e){const{sortedItems:a,paginate:l,group:n}=e,o=t.toValue(e.pageBy)
...
return{pageCount:o,setItemsPerPage:r,prevPage:i,nextPage:s,setPage:u,paginatedItems:t}}throw new Error(`Unrecognized pagination target ${o}`)}({pageBy:I,sortedItems:E,paginate:e=>{const a=t.computed(()=>t.toValue(e).length),{startIndex:l,stopIndex:n,pageCount:o,setItemsPerPage:r,prevPage:i,nextPage:s,setPage:d}=Fd({page:u,itemsPerPage:c,itemsLength:a}),{paginatedItems:v}=$d({items:e,startIndex:l,stopIndex:n,itemsPerPage:c})
return{paginatedItems:v,pageCount:o,setItemsPerPage:r,prevPage:i,nextPage:s,setPage:d}},group:e=>Rd(e,n,S,()=>!!l["group-summary"])}),B=t.computed(()=>k(D.value)),{isSelected:F,select:$,selectAll:M,toggleSelect:z,someSelected:L,allSelected:O}=Hd(e,{allItems:h,currentPage:B}),{isExpanded:j,toggleExpand:H}=Sd(e)
Ad({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:y}),vt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
return It(()=>{const n=ov.filterProps(e),o=xv.filterProps(x(e,["multiSort"])),r=Pv.filterProps(e),i=Av.filterProps(e)
return t.createVNode(Av,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>l.top?.(W.value),default:()=>l.default?l.default(W.value):t.createElementVNode(t.Fragment,null,[l.colgroup?.(W.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(xv,t.mergeProps(o,{multiSort:!!e.multiSort}),l)]),l.thead?.(W.value),!e.hideDefaultBody&&t.createElementVNode("tbody",null,[l["body.prepend"]?.(W.value),l.body?l.body(W.value):t.createVNode(Pv,t.mergeProps(a,r,{items:D.value}),l),l["body.append"]?.(W.value)]),l.tbody?.(W.value),l.tfoot?.(W.value)]),bottom:()=>l.bottom?l.bottom(W.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(Zo,null,null),t.createVNode(ov,n,{prepend:l["footer.prepend"]})])})}),{}}}),zv=rt({...x(Fv(),["hideDefaultFooter"]),...xd(),...Yi(),...ts()},"VDataTableVirtual"),Lv=ft()({name:"VDataTableVirtual",props:zv(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,{attrs:a,slots:l}){const{groupBy:n}=Cd(e),{initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}=Gd(e),{disableSort:u}=t.toRefs(e),{columns:c,headers:d,filterFunctions:v,sortFunctions:p,sortRawFunctions:m}=wv(e,{groupBy:n,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=Bv(e,c),h=t.toRef(()=>e.search),{filteredItems:y}=as(e,g,h,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:b}=Kd({initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:V,opened:w,extractRows:S,isGroupOpen:k,toggleGroup:N}=Ed({groupBy:n,sortBy:r,disableSort:u}),{sortedItems:C}=Xd(e,y,V,{transform:e=>({...e.raw,...e.columns}),sortFunctions:p,sortRawFunctions:m}),{flatItems:E}=Rd(C,n,w,()=>!!l["group-summary"]),I=t.computed(()=>S(E.value)),{isSelected:_,select:P,selectAll:R,toggleSelect:A,someSelected:T,allSelected:D}=Hd(e,{allItems:I,currentPage:I}),{isExpanded:B,toggleExpand:F}=Sd(e),{containerRef:$,markerRef:M,paddingTop:z,paddingBottom:L,computedItems:O,handleItemResize:j,handleScroll:H,handleScrollend:W,calculateVisibleItems:U,scrollToIndex:Y}=Gi(e,E),G=t.computed(()=>O.value.map(e=>({...e.raw,virtualIndex:e.index})))
Ad({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:h}),vt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
return It(()=>{const n=xv.filterProps(x(e,["multiSort"])),o=Pv.filterProps(e),r=Av.filterProps(e)
return t.createVNode(Av,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>l.top?.(K.value),wrapper:()=>t.createElementVNode("div",{ref:$,onScrollPassive:H,onScrollend:W,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createElementVNode("table",null,[l.colgroup?.(K.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(xv,t.mergeProps(n,{multiSort:!!e.multiSort}),l)]),l.thead?.(K.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{key:"tbody"},[t.createElementVNode("tr",{ref:M,style:{height:f(z.value),border:0}},[t.createElementVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),l["body.prepend"]?.(K.value),t.createVNode(Pv,t.mergeProps(a,o,{items:G.value}),{...l,item:e=>t.createVNode(Ui,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>j(e.internalItem.index,t)},{default:({itemRef:a})=>l.item?.({...e,itemRef:a})??t.createVNode(Iv,t.mergeProps(e.props,{ref:a,key:e.internalItem.index,index:e.index}),l)})}),l["body.append"]?.(K.value),t.createElementVNode("tr",{style:{height:f(L.value),border:0}},[t.createElementVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)])]),l.tbody?.(K.value),l.tfoot?.(K.value)])]),bottom:()=>l.bottom?.(K.value)})}),{calculateVisibleItems:U,scrollToIndex:Y}}}),Ov=rt({itemsLength:{type:[Number,String],required:!0},...Td(),...Fv(),...nv()},"VDataTableServer"),jv=ft()({name:"VDataTableServer",props:Ov(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,{attrs:a,slots:l}){const{groupBy:n}=Cd(e),{initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}=Gd(e),{page:u,itemsPerPage:c}=Bd(e),{disableSort:d}=t.toRefs(e),v=t.computed(()=>parseInt(e.itemsLength,10)),{columns:p,headers:m}=wv(e,{groupBy:n,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:f}=Bv(e,p),{toggleSort:g}=Kd({initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:h,isGroupOpen:y,toggleGroup:b,extractRows:V}=Ed({groupBy:n,sortBy:r,disableSort:d}),{pageCount:w,setItemsPerPage:S,prevPage:k,nextPage:N,setPage:C}=Fd({page:u,itemsPerPage:c,itemsLength:v}),{flatItems:E}=Rd(f,n,h,()=>!!l["group-summary"]),{isSelected:I,select:_,selectAll:P,toggleSelect:R,someSelected:A,allSelected:T}=Hd(e,{allItems:f,currentPage:f}),{isExpanded:D,toggleExpand:B}=Sd(e),F=t.computed(()=>V(f.value))
Ad({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef(()=>e.search)}),t.provide("v-data-table",{toggleSort:g,sortBy:r}),vt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
It(()=>{const n=ov.filterProps(e),o=xv.filterProps(x(e,["multiSort"])),r=Pv.filterProps(e),i=Av.filterProps(e)
return t.createVNode(Av,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>l.top?.($.value),default:()=>l.default?l.default($.value):t.createElementVNode(t.Fragment,null,[l.colgroup?.($.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(xv,t.mergeProps(o,{multiSort:!!e.multiSort}),l)]),l.thead?.($.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[l["body.prepend"]?.($.value),l.body?l.body($.value):t.createVNode(Pv,t.mergeProps(a,r,{items:E.value}),l),l["body.append"]?.($.value)]),l.tbody?.($.value),l.tfoot?.($.value)]),bottom:()=>l.bottom?l.bottom($.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(Zo,null,null),t.createVNode(ov,n,{prepend:l["footer.prepend"]})])})})}}),Hv=rt({fluid:{type:Boolean,default:!1},...it(),...el(),...xa()},"VContainer"),Wv=ft()({name:"VContainer",props:Hv(),setup(e,{slots:a}){const{rtlClasses:l}=ca(),{dimensionStyles:n}=tl(e)
return It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-container",{"v-container--fluid":e.fluid},l.value,e.class]),style:t.normalizeStyle([n.value,e.style])},a)),{}}}),Uv=ko.reduce((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e),{}),Yv=ko.reduce((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e),{}),Gv={col:V(Uv),offset:V(Yv),order:["order","orderSm","orderMd","orderLg","orderXl","orderXxl"]}
function Kv(e){if("string"==typeof e&&e.includes("/")){const[t,a]=e.split("/")
return{cols:Number(t),size:Number(a)}}return{cols:e}}function qv(e,t,a){if(null==a||!1===a)return{}
const{cols:l,size:n}=Kv(a),o=t.replace(e,"").toLowerCase()
return"offset"===e?{className:`v-col--offset-${o}-${l}`,variables:[{[`--v-col-offset-base-${o}`]:n}]}:"order"===e?{className:`order-${o}-${l}`}:{className:""===l||!0===l?`v-col--${o}`:`v-col--cols-${o}-${l}`,variables:[{[`--v-col-size-base-${o}`]:n}]}}const Xv=["auto","start","end","center","baseline","stretch"],Zv=rt({cols:{type:[Boolean,String,Number],default:!1},...Uv,offset:{type:[String,Number],default:null},...Yv,order:{type:[String,Number],default:null},orderSm:{type:[String,Number],default:null},orderMd:{type:[String,Number],default:null},orderLg:{type:[String,Number],default:null},orderXl:{type:[String,Number],default:null},orderXxl:{type:[String,Number],default:null},alignSelf:{type:String,default:null,validator:e=>Xv.includes(e)},...it(),...xa()},"VCol"),Qv=ft()({name:"VCol",props:Zv(),setup(e,{slots:a}){const l=t.computed(()=>Kv(e.cols).size),n=t.computed(()=>Kv(e.offset).size),o=t.computed(()=>{const t=["v-col"],a=[]
let l
for(l in Gv)Gv[l].forEach(n=>{const o=e[n],{className:r,variables:i}=qv(l,n,o)
r&&t.push(r),i&&a.push(...i)})
const{cols:n}=Kv(e.cols),{cols:o}=Kv(e.offset)
...
return()=>t.h(e.tag,{class:[o.value.classes,e.class],style:[{"--v-col-size-base":l.value},{"--v-col-offset-base":n.value},o.value.variables,e.style]},a.default?.())}}),Jv=["start","end","center"],ep=["space-between","space-around","space-evenly"],tp=[...Jv,"baseline","stretch"],ap=e=>tp.includes(e),lp=[...Jv,...ep],np=e=>lp.includes(e),op=[...Jv,...ep,"stretch"],rp=e=>op.includes(e),ip={align:["align","alignSm","alignMd","alignLg","alignXl","alignXxl"],justify:["justify","justifySm","justifyMd","justifyLg","justifyXl","justifyXxl"],alignContent:["alignContent","alignContentSm","alignContentMd","alignContentLg","alignContentXl","alignContentXxl"]},sp={align:"align",justify:"justify",alignContent:"align-content"}
function up(e,t,a){let l=sp[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const cp=rt({dense:Boolean,align:{type:String,default:null,validator:ap},alignSm:{type:String,default:null,validator:ap},alignMd:{type:String,default:null,validator:ap},alignLg:{type:String,default:null,validator:ap},alignXl:{type:String,default:null,validator:ap},alignXxl:{type:String,default:null,validator:ap},justify:{type:String,default:null,validator:np},justifySm:{type:String,default:null,validator:np},justifyMd:{type:String,default:null,validator:np},justifyLg:{type:String,default:null,validator:np},justifyXl:{type:String,default:null,validator:np},justifyXxl:{type:String,default:null,validator:np},alignContent:{type:String,default:null,validator:rp},alignContentSm:{type:String,default:null,validator:rp},alignContentMd:{type:String,default:null,validator:rp},alignContentLg:{type:String,default:null,validator:rp},alignContentXl:{type:String,default:null,validator:rp},alignContentXxl:{type:String,default:null,validator:rp},noGutters:Boolean,gap:[Number,String,Array],size:[Number,String],...it(),...Al(),...xa()},"VRow"),dp=ft()({name:"VRow",props:cp(),setup(e,{slots:a}){e.dense&&n("dense",'density="comfortable"')
const l=t.computed(()=>{const t=[]
let a
for(a in ip)ip[a].forEach(l=>{const n=e[l],o=up(a,l,n)
o&&t.push(o)})
...
return{minDate:l,maxDate:n,clampDate:function(e){return l.value&&a.isBefore(e,l.value)?l.value:n.value&&a.isAfter(e,n.value)?n.value:e},isInAllowedRange:function(e){return(!l.value||a.isAfter(e,l.value))&&(!n.value||a.isBefore(e,n.value))}}}const bp=rt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,readonly:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},events:{type:[Array,Function,Object],default:()=>null},eventColor:{type:[Array,Function,Object,String],default:()=>null},...x(hp(),["displayValue"])},"VDatePickerMonth"),Vp=ft()({name:"VDatePickerMonth",props:bp(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,{emit:a,slots:l}){const n=t.ref(),{t:o}=sa(),{daysInMonth:r,model:i,weekNumbers:s,weekdayLabels:u}=function(e){const a=Iu(),l=Zt(e,"modelValue",[],e=>P(e).map(e=>a.date(e))),n=t.computed(()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date()),o=Zt(e,"year",void 0,e=>{const t=null!=e?Number(e):a.getYear(n.value)
...
return f.value&&!r&&(a.isDisabled=!0),t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-month__day",{"v-date-picker-month__day--adjacent":a.isAdjacent,"v-date-picker-month__day--hide-adjacent":a.isHidden,"v-date-picker-month__day--selected":r,"v-date-picker-month__day--week-end":a.isWeekEnd,"v-date-picker-month__day--week-start":a.isWeekStart}]),"data-v-date":a.isDisabled?void 0:a.isoDate},[(e.showAdjacentMonths||!a.isAdjacent)&&(l.day?.(o)??t.createVNode(Dn,o.props,{default:()=>[a.localized,y(a.isoDate)]}))])})])]})]))}}),wp=rt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,year:Number,allowedMonths:[Array,Function]},"VDatePickerMonths"),Sp=ft()({name:"VDatePickerMonths",props:wp(),emits:{"update:modelValue":e=>!0},setup(e,{emit:a,slots:l}){const n=Iu(),o=Zt(e,"modelValue"),r=t.computed(()=>{let t=n.startOfYear(n.date())
...
o.value=e}(r)}
return l.month?.({month:n,i:r,props:i})??t.createVNode(Dn,t.mergeProps({key:"month"},i),null)})])])),{}}}),kp=rt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,allowedYears:[Array,Function]},"VDatePickerYears"),xp=ft()({name:"VDatePickerYears",props:kp(),directives:{vIntersect:ml},emits:{"update:modelValue":e=>!0},setup(e,{emit:a,slots:l}){const n=Iu(),o=Zt(e,"modelValue"),r=t.shallowRef(!1),i=t.computed(()=>{const t=n.getYear(n.date())
let a=t-100,l=t+52
...
return l.year?.({year:n,i:r,props:i})??t.createVNode(Dn,t.mergeProps({key:"month"},i),null)})])]),[[ml,{handler:c},null,{once:!0}]])),{}}}),Np=rt({header:{type:String,default:"$vuetify.datePicker.header"},headerColor:String,headerDateFormat:{type:String,default:"normalDateWithWeekday"},landscapeHeaderWidth:[Number,String],...x(pp(),["active","monthText","yearText"]),...bp({weeksInMonth:"static"}),...x(wp(),["modelValue"]),...x(kp(),["modelValue"]),...pd({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Cp=ft()({name:"VDatePicker",props:Np(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,{emit:a,slots:l}){const n=Iu(),{t:o}=sa(),{rtlClasses:r}=ca(),i=Zt(e,"modelValue",void 0,e=>P(e).map(e=>n.date(e)),t=>e.multiple?t:t[0]),s=Zt(e,"viewMode"),{minDate:u,maxDate:c,clampDate:d}=yp(e),v=t.computed(()=>{const e=n.date(),t=i.value?.[0]?n.date(i.value[0]):d(e)
...
i!==g.value&&(g.value=i,O()),s!==y.value&&(y.value=s,j()),b.value=n.isBefore(o,r)}),It(()=>{const a=md.filterProps(e),n=x(mp.filterProps(e),["viewMode"]),d=gp.filterProps(e),v=Vp.filterProps(e),m=x(Sp.filterProps(e),["modelValue"]),h=x(xp.filterProps(e),["modelValue"]),b={color:p.value,header:V.value,transition:C.value}
return t.createVNode(md,t.mergeProps(a,{color:p.value,class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},r.value,e.class],style:[{"--v-date-picker-landscape-header-width":f(e.landscapeHeaderWidth)},e.style]}),{title:()=>l.title?.()??t.createElementVNode("div",{class:"v-date-picker__title"},[o(e.title)]),header:()=>l.header?t.createVNode(Ja,{defaults:{VDatePickerHeader:{...b}}},{default:()=>[l.header?.(b)]}):t.createVNode(gp,t.mergeProps({key:"header"},d,b,{onClick:"month"!==s.value?M:void 0}),{prepend:l.prepend,append:l.append}),default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(mp,t.mergeProps(n,{disabled:E.value,viewMode:s.value,text:S.value,monthText:k.value,yearText:N.value,"onClick:next":D,"onClick:prev":B,"onClick:nextYear":F,"onClick:prevYear":$,"onClick:month":z,"onClick:year":L}),{default:l.controls}),t.createVNode(za,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Sp,t.mergeProps({key:"date-picker-months"},m,{modelValue:g.value,"onUpdate:modelValue":[e=>g.value=e,O],min:u.value,max:c.value,year:y.value,allowedMonths:_.value}),{month:l.month}):"year"===s.value?t.createVNode(xp,t.mergeProps({key:"date-picker-years"},h,{modelValue:y.value,"onUpdate:modelValue":[e=>y.value=e,j],min:u.value,max:c.value,allowedYears:I.value}),{year:l.year}):t.createVNode(Vp,t.mergeProps({key:"date-picker-month"},v,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:g.value,"onUpdate:month":[e=>g.value=e,O],year:y.value,"onUpdate:year":[e=>y.value=e,j],min:u.value,max:c.value}),{day:l.day})]})]),actions:l.actions})}),{}}}),Ep=rt({actionText:String,bgColor:String,color:String,icon:_t,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...it(),...el(),...ql({size:void 0}),...va()},"VEmptyState"),Ip=ft()({name:"VEmptyState",props:Ep(),emits:{"click:action":e=>!0},setup(e,{emit:a,slots:l}){const{themeClasses:n}=Va(e),{backgroundColorClasses:o,backgroundColorStyles:r}=rl(()=>e.bgColor),{dimensionStyles:i}=tl(e),{displayClasses:s}=Ro()
...
function Op(e,t=""){return new Promise((a,l)=>{if(e.isFile){e.file(e=>a([{file:e,path:t}]),l)}else if(e.isDirectory){e.createReader().readEntries(async e=>{const l=[]
for(const a of e)l.push(...await Op(a,jp(t,a)))
a(l)})}})}function jp(e,t){return t.isDirectory?`${e}/${t.name}`:e}const Hp=rt({filterByType:String},"file-accept")
const Wp=rt({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},truncateLength:{type:[Number,String],default:22},...x(go({prependIcon:"$file"}),["direction"]),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>P(e).every(e=>null!=e&&"object"==typeof e)},...Hp(),...Fi({clearable:!0})},"VFileInput"),Up=ft()({name:"VFileInput",inheritAttrs:!1,props:Wp(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0,rejected:e=>!0},setup(e,{attrs:a,emit:l,slots:n}){const{t:o}=sa(),{filterAccepted:r}=function(e){const a=t.computed(()=>e.filterByType?function(e){const t=e.split(",").map(e=>e.trim().toLowerCase()),a=t.filter(e=>e.startsWith(".")),l=t.filter(e=>e.endsWith("/*")),n=t.filter(e=>!a.includes(e)&&!l.includes(e))
...
if(a.length)for(const e of a){const a=await Op(e,jp(".",e))
...
function Qp(e,t,a){const l=a&&e.mac?e.mac:e.default,n="icon"===t&&!l.icon||"symbol"===t&&!l.symbol?"text":t
let o=l[n]??l.text
return"text"===n&&"string"==typeof o&&o.startsWith("$")&&!o.startsWith("$vuetify.")&&(o=o.slice(1).toUpperCase()),"icon"===n?["icon",o]:[n,o]}const Jp={ctrl:{mac:{symbol:"⌃",icon:"$ctrl",text:"$vuetify.hotkey.ctrl"},default:{text:"Ctrl"}},meta:{mac:{symbol:"⌘",icon:"$command",text:"$vuetify.hotkey.command"},default:{text:"Ctrl"}},cmd:{mac:{symbol:"⌘",icon:"$command",text:"$vuetify.hotkey.command"},default:{text:"Ctrl"}},shift:{mac:{symbol:"⇧",icon:"$shift",text:"$vuetify.hotkey.shift"},default:{text:"Shift"}},alt:{mac:{symbol:"⌥",icon:"$alt",text:"$vuetify.hotkey.option"},default:{text:"Alt"}},enter:{default:{symbol:"↵",icon:"$enter",text:"$vuetify.hotkey.enter"}},arrowup:{default:{symbol:"↑",icon:"$arrowup",text:"$vuetify.hotkey.upArrow"}},arrowdown:{default:{symbol:"↓",icon:"$arrowdown",text:"$vuetify.hotkey.downArrow"}},arrowleft:{default:{symbol:"←",icon:"$arrowleft",text:"$vuetify.hotkey.leftArrow"}},arrowright:{default:{symbol:"→",icon:"$arrowright",text:"$vuetify.hotkey.rightArrow"}},backspace:{default:{symbol:"⌫",icon:"$backspace",text:"$vuetify.hotkey.backspace"}},escape:{default:{text:"$vuetify.hotkey.escape"}}," ":{mac:{symbol:"␣",icon:"$space",text:"$vuetify.hotkey.space"},default:{text:"$vuetify.hotkey.space"}},"-":{default:{text:"-"}},"+":{default:{text:"+"}}},em=rt({keys:String,displayMode:{type:String,default:"icon"},keyMap:{type:Object,default:()=>Jp},platform:{type:String,default:"auto"},inline:Boolean,disabled:Boolean,prefix:String,suffix:String,variant:{type:String,default:"elevated",validator:e=>["elevated","flat","tonal","outlined","text","plain","contained"].includes(e)},...it(),...va(),...hl(),...sl(),...bl(),color:String},"VHotkey"),tm=Symbol("VHotkey:AND_DELINEATOR"),am=Symbol("VHotkey:OR_DELINEATOR"),lm=Symbol("VHotkey:THEN_DELINEATOR")
function nm(e,t,a,l){const n=a.toLowerCase()
if(n in e){const o=Qp(e[n],t,l)
return"text"===o[0]&&"string"==typeof o[1]&&o[1].startsWith("$")&&!o[1].startsWith("$vuetify.")?["text",o[1].replace("$","").toUpperCase(),a]:[...o,a]}return["text",a.toUpperCase(),a]}const om=ft()({name:"VHotkey",props:em(),setup(e){const{t:a}=sa(),{themeClasses:l}=Va(e),{rtlClasses:n}=ca(),{borderClasses:o}=yl(e),{roundedClasses:r}=ul(e),{elevationClasses:i}=Vl(e),{colorClasses:s,colorStyles:u,variantClasses:c}=$l(()=>({color:e.color,variant:"contained"===e.variant?"elevated":e.variant})),d=t.computed(()=>"auto"===e.platform?"undefined"!=typeof navigator&&/macintosh/i.test(navigator.userAgent):"mac"===e.platform),v=t.computed(()=>e.keys?e.keys.split(/\b \b/).map(t=>{const a=[]
return function t(l){if("string"==typeof l)""!==l&&a.push(nm(e.keyMap,e.displayMode,l,d.value))
else for(let e=0;e<l.parts.length;e++)e>0&&("sequence"===l.type?a.push(lm):"alternate"===l.type?a.push(am):"combo"===l.type&&a.push(tm)),t(l.parts[e])}(zu(t)),a}):[]),p=t.computed(()=>{if(!e.keys)return""
const t=v.value.map(t=>{const l=[]
for(const n of t)if(Array.isArray(n)){const t="icon"===n[0]||"symbol"===n[0]?nm($(Jp,e.keyMap),"text",String(n[1]),d.value)[1]:n[1]
l.push(m(t))}else n===tm?l.push(a("$vuetify.hotkey.plus")):n===am?l.push(a("$vuetify.hotkey.or")):n===lm&&l.push(a("$vuetify.hotkey.then"))
return l.join(" ")}).join(", ")
...
if(l in e){const t=Qp(e[l],"text",a)
return"string"==typeof t[1]?t[1]:String(t[1])}return t.toUpperCase()}(e.keyMap,String(t[2]),d.value)
return m(a)}It(()=>{const d=t.createElementVNode(t.Fragment,null,[e.prefix&&t.createElementVNode("span",{key:"prefix",class:"v-hotkey__prefix"},[e.prefix]),v.value.map((l,n)=>t.createElementVNode("span",{class:"v-hotkey__combination",key:n},[l.map((l,n)=>Array.isArray(l)?function(a,l){const n="contained"===e.variant,c=n?"kbd":Zp,d=["v-hotkey__key",`v-hotkey__key-${a[0]}`,...n?["v-hotkey__key--nested"]:[o.value,r.value,i.value,s.value]]
return t.createVNode(c,{key:l,class:t.normalizeClass(d),style:t.normalizeStyle(n?void 0:u.value),"aria-hidden":"true",title:f(a)},{default:()=>["icon"===a[0]?t.createVNode(Ql,{icon:a[1],"aria-hidden":"true"},null):m(a[1])]})}(l,n):function(e,l){return t.createElementVNode("span",{key:l,class:"v-hotkey__divider","aria-hidden":"true"},[e===tm?"+":a(e===am?"$vuetify.hotkey.or":"$vuetify.hotkey.then")])}(l,n)),n<v.value.length-1&&t.createElementVNode("span",{"aria-hidden":"true"},[t.createTextVNode(" ")])])),e.suffix&&t.createElementVNode("span",{key:"suffix",class:"v-hotkey__suffix"},[e.suffix])])
return t.createElementVNode("div",{class:t.normalizeClass(["v-hotkey",{"v-hotkey--disabled":e.disabled,"v-hotkey--inline":e.inline,"v-hotkey--contained":"contained"===e.variant},l.value,n.value,c.value,e.class]),style:t.normalizeStyle(e.style),role:"img","aria-label":p.value},["contained"!==e.variant?d:t.createVNode(Zp,{key:"contained",class:t.normalizeClass(["v-hotkey__contained-wrapper",o.value,r.value,i.value,s.value]),style:t.normalizeStyle(u.value),"aria-hidden":"true"},{default:()=>[d]})])})}}),rm=rt({disabled:Boolean,modelValue:{type:Boolean,default:null},...li()},"VHover"),im=ft()({name:"VHover",props:rm(),emits:{"update:modelValue":e=>!0},setup(e,{slots:t}){const a=Zt(e,"modelValue"),{runOpenDelay:l,runCloseDelay:n}=ni(e,t=>!e.disabled&&(a.value=t))
return()=>t.default?.({isHovering:a.value,props:{onMouseenter:l,onMouseleave:n}})}}),sm=rt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...el(),...xa()},"VInfiniteScroll"),um=mt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,{emit:a}){const{intersectionRef:l,isIntersecting:n}=Jl()
return t.watch(n,async t=>{a("intersect",e.side,t)}),It(()=>t.createElementVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:l},[t.createTextVNode(" ")])),{}}}),cm=ft()({name:"VInfiniteScroll",props:sm(),emits:{load:e=>!0},setup(e,{slots:a,emit:l}){const n=t.ref(),o=t.shallowRef("ok"),r=t.shallowRef("ok"),i=t.computed(()=>f(e.margin)),s=t.shallowRef(!1)
...
return t.createVNode(l,{ref:n,class:t.normalizeClass(["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":s,"v-infinite-scroll--end":u}]),style:t.normalizeStyle(b.value)},{default:()=>[t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("start",o.value)]),s&&c&&t.createVNode(um,{key:"start",side:"start",onIntersect:m,rootMargin:i.value},null),a.default?.(),u&&c&&t.createVNode(um,{key:"end",side:"end",onIntersect:m,rootMargin:i.value},null),t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("end",r.value)])]})}),{reset:function(a){const l=a??e.side
v(l,"ok"),t.nextTick(()=>{"end"!==l&&u(d()-p+c()),"manual"!==e.mode&&t.nextTick(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{"both"===l?(g("start"),g("end")):g(l)})})})})})}}}}),dm=Symbol.for("vuetify:v-item-group"),vm=rt({...it(),...Ll({selectedClass:"v-item--selected"}),...xa(),...va()},"VItemGroup"),pm=ft()({name:"VItemGroup",props:vm(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{themeClasses:l}=Va(e),{isSelected:n,select:o,next:r,prev:i,selected:s}=Hl(e,dm)
return()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-item-group",l.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[a.default?.({isSelected:n,select:o,next:r,prev:i,selected:s.value})]})}}),mm=ft()({name:"VItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,{slots:t}){const{isSelected:a,select:l,toggle:n,selectedClass:o,value:r,disabled:i}=jl(e,dm)
return()=>t.default?.({isSelected:a.value,selectedClass:o.value,select:l,toggle:n,value:r.value,disabled:i.value})}}),fm=rt({...it(),...el(),...Ut()},"VLayout"),gm=ft()({name:"VLayout",props:fm(),setup(e,{slots:a}){const{layoutClasses:l,layoutStyles:n,getLayoutItem:o,items:r,layoutRef:i}=qt(e),{dimensionStyles:s}=tl(e)
return It(()=>t.createElementVNode("div",{ref:i,class:t.normalizeClass([l.value,e.class]),style:t.normalizeStyle([s.value,n.value,e.style])},[a.default?.()])),{getLayoutItem:o,items:r}}}),hm=rt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...it(),...Yt()},"VLayoutItem"),ym=ft()({name:"VLayoutItem",props:hm(),setup(e,{slots:a}){const{layoutItemStyles:l}=Kt({id:e.name,order:t.computed(()=>parseInt(e.order,10)),position:t.toRef(()=>e.position),elementSize:t.toRef(()=>e.size),layoutSize:t.toRef(()=>e.size),active:t.toRef(()=>e.modelValue),absolute:t.toRef(()=>e.absolute)})
return()=>t.createElementVNode("div",{class:t.normalizeClass(["v-layout-item",e.class]),style:t.normalizeStyle([l.value,e.style])},[a.default?.()])}}),bm=rt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...it(),...el(),...xa(),...cl({transition:"fade-transition"})},"VLazy"),Vm=ft()({name:"VLazy",directives:{vIntersect:ml},props:bm(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{dimensionStyles:l}=tl(e),n=Zt(e,"modelValue")
function o(e){n.value||(n.value=e)}return It(()=>t.withDirectives(t.createVNode(e.tag,{class:t.normalizeClass(["v-lazy",e.class]),style:t.normalizeStyle([l.value,e.style])},{default:()=>[n.value&&t.createVNode(dl,{transition:e.transition,appear:!0},{default:()=>[a.default?.()]})]}),[[ml,{handler:o,options:e.options},null]])),{}}}),wm=rt({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...it()},"VLocaleProvider"),Sm=ft()({name:"VLocaleProvider",props:wm(),setup(e,{slots:a}){const{rtlClasses:l}=ua(e)
return It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-locale-provider",l.value,e.class]),style:t.normalizeStyle(e.style)},[a.default?.()])),{}}}),km=rt({scrollable:Boolean,...it(),...el(),...xa({tag:"main"})},"VMain"),xm=ft()({name:"VMain",props:km(),setup(e,{slots:a}){const{dimensionStyles:l}=tl(e),{mainStyles:n}=Gt(),{ssrBootStyles:o}=Il()
...
function Nm(e){return(e<0?-1:1)*Math.sqrt(Math.abs(e))*1.41421356237}function Cm(e){if(e.length<2)return 0
if(2===e.length)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t)
let t=0
for(let a=e.length-1;a>0;a--){if(e[a].t===e[a-1].t)continue
const l=Nm(t),n=(e[a].d-e[a-1].d)/(e[a].t-e[a-1].t)
t+=(n-l)*Math.abs(n),a===e.length-1&&(t*=.5)}return 1e3*Nm(t)}function Em(){const e={}
...
n.push({t:e[0],d:e[1].clientX}),o.push({t:e[0],d:e[1].clientY})}return{x:Cm(n),y:Cm(o),get direction(){const{x:e,y:t}=this,[a,l]=[Math.abs(e),Math.abs(t)]
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Im(){throw new Error}const _m=["start","end","left","right","top","bottom"],Pm=rt({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>_m.includes(e)},sticky:Boolean,...hl(),...it(),...li(),...Po({mobile:null}),...bl(),...Yt(),...sl(),...x(si(),["disableInitialFocus"]),...xa({tag:"nav"}),...va()},"VNavigationDrawer"),Rm=ft()({name:"VNavigationDrawer",props:Pm(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,{attrs:a,emit:l,slots:n}){const{isRtl:o}=ca(),{themeClasses:r}=Va(e),{borderClasses:i}=yl(e),{backgroundColorClasses:s,backgroundColorStyles:u}=rl(()=>e.color),{elevationClasses:c}=Vl(e),{displayClasses:d,mobile:v}=Ro(e),{roundedClasses:p}=ul(e),m=pn(),g=Zt(e,"modelValue",null,e=>!!e),{ssrBootStyles:h}=Il(),{scopeId:y}=gi(),b=t.ref(),V=t.shallowRef(!1),{runOpenDelay:w,runCloseDelay:S}=ni(e,e=>{V.value=e}),k=t.computed(()=>e.rail&&e.expandOnHover&&V.value?Number(e.width):Number(e.rail?e.railWidth:e.width)),x=t.computed(()=>ce(e.location,o.value)),N=t.toRef(()=>e.persistent),C=t.computed(()=>!e.permanent&&(v.value||e.temporary)),E=t.computed(()=>e.sticky&&!C.value&&"bottom"!==x.value)
...
a.value=o?t.direction===({left:"right",right:"left",top:"down",bottom:"up"}[r.value]||Im()):p.value>.5}const w=t.computed(()=>v.value?{transform:"left"===r.value?`translateX(calc(-100% + ${p.value*n.value}px))`:"right"===r.value?`translateX(calc(100% - ${p.value*n.value}px))`:"top"===r.value?`translateY(calc(-100% + ${p.value*n.value}px))`:"bottom"===r.value?`translateY(calc(100% - ${p.value*n.value}px))`:Im(),transition:"none"}:void 0)
...
const $m=rt({scale:{type:[Number,String],default:.5},...it()},"VParallax"),Mm=ft()({name:"VParallax",props:$m(),setup(e,{slots:a}){const{intersectionRef:l,isIntersecting:n}=Jl(),{resizeRef:o,contentRect:r}=jt(),{height:i}=Ro(),s=t.ref()
let u
...
const a=Zc(t,o.value.$el,e.direction),l=Zc(t,r.value.$el,e.direction),n=Math.abs(a),i=Math.abs(l)
...
return t.createVNode(e.tag,{class:t.normalizeClass(["v-rating",{"v-rating--hover":e.hover,"v-rating--readonly":e.readonly},n.value,e.class]),style:t.normalizeStyle(e.style),ref:o},{default:()=>[t.createVNode(b,{value:0,index:-1,showStar:!1},null),s.value.map((a,n)=>t.createElementVNode("div",{class:"v-rating__wrapper"},[l&&"top"===e.itemLabelPosition?V({value:a,index:n,label:e.itemLabels?.[n]}):void 0,t.createElementVNode("div",{class:"v-rating__item"},[e.halfIncrements?t.createElementVNode(t.Fragment,null,[t.createVNode(b,{value:a-.5,index:2*n},null),t.createVNode(b,{value:a,index:2*n+1},null)]):t.createVNode(b,{value:a,index:n},null)]),l&&"bottom"===e.itemLabelPosition?V({value:a,index:n,label:e.itemLabels?.[n]}):void 0]))]})}),{}}}),Gm={actions:"button@2",article:"heading, paragraph",avatar:"avatar",button:"button",card:"image, heading","card-avatar":"image, list-item-avatar",chip:"chip","date-picker":"list-item, heading, divider, date-picker-options, date-picker-days, actions","date-picker-options":"text, avatar@2","date-picker-days":"avatar@28",divider:"divider",heading:"heading",image:"image","list-item":"text","list-item-avatar":"avatar, text","list-item-two-line":"sentences","list-item-avatar-two-line":"avatar, sentences","list-item-three-line":"paragraph","list-item-avatar-three-line":"avatar, paragraph",ossein:"ossein",paragraph:"text@3",sentences:"text@2",subtitle:"text",table:"table-heading, table-thead, table-tbody, table-tfoot","table-heading":"chip, text","table-thead":"heading@6","table-tbody":"table-row-divider@6","table-row-divider":"table-row, divider","table-row":"text@6","table-tfoot":"text@2, avatar@2",text:"text"}
function Km(e,a=[]){return t.createElementVNode("div",{class:t.normalizeClass(["v-skeleton-loader__bone",`v-skeleton-loader__${e}`])},[a])}function qm(e){const[t,a]=e.split("@")
return Array.from({length:a}).map(()=>Xm(t))}function Xm(e){let t=[]
if(!e)return t
const a=Gm[e]
if(e===a);else{if(e.includes(","))return Zm(e)
if(e.includes("@"))return qm(e)
a.includes(",")?t=Zm(a):a.includes("@")?t=qm(a):a&&t.push(Xm(a))}return[Km(e,t)]}function Zm(e){return e.replace(/\s/g,"").split(",").map(Xm)}const Qm=rt({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...el(),...bl(),...va()},"VSkeletonLoader"),Jm=ft()({name:"VSkeletonLoader",inheritAttrs:!1,props:Qm(),setup(e,{attrs:a,slots:l}){const{backgroundColorClasses:n,backgroundColorStyles:o}=rl(()=>e.color),{dimensionStyles:r}=tl(e),{elevationClasses:i}=Vl(e),{themeClasses:s}=Va(e),{t:u}=sa(),c=t.computed(()=>Xm(P(e.type).join(",")))
return It(()=>{const d=!l.default||e.loading,v=e.boilerplate||!d?{}:{ariaLive:"polite",ariaLabel:u(e.loadingText),role:"alert"}
return d?t.createElementVNode("div",t.mergeProps({class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},s.value,n.value,i.value],style:[o.value,r.value]},v,a),[c.value]):t.createElementVNode(t.Fragment,null,[l.default?.()])}),{}}}),ef=ft()({name:"VSlideGroupItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,{slots:t}){const a=jl(e,Oo)
return()=>t.default?.({isSelected:a.isSelected.value,select:a.select,toggle:a.toggle,selectedClass:a.selectedClass.value})}}),tf=Symbol.for("vuetify:v-snackbar-queue")
const af=rt({collapsed:Object,loading:Boolean,prependAvatar:String,prependIcon:_t,queueGap:Number,queueIndex:Number,title:String,text:String,reverseTimer:Boolean,timer:{type:[Boolean,String],default:!1},timerColor:String,timeout:{type:[Number,String],default:5e3},vertical:Boolean,...Sl({location:"bottom"}),...dn(),...sl(),...Fl(),...va(),...x(Ni({closeOnBack:!1,transition:"v-snackbar-transition"}),["persistent","noClickAnimation","offset","retainFocus","captureFocus","disableInitialFocus","scrim","scrollStrategy","stickToTarget","viewportMargin"])},"VSnackbar"),lf=ft()({name:"VSnackbar",props:af(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=Zt(e,"modelValue"),{positionClasses:n}=vn(e),{scopeId:o}=gi(),{themeClasses:r}=Va(e),{colorClasses:i,colorStyles:s,variantClasses:u}=$l(e),{roundedClasses:c}=ul(e),d=function(e){const a=t.shallowRef(e())
let l=-1
...
a.value=Math.max(e()-t,0),a.value<=0&&n()},r)},reset:function(){n(),t.nextTick(()=>a.value=e())}}}(()=>Number(e.timeout)),v=t.ref(),p=function(e,a){const l=t.inject(tf,null)
if(!l)return null
const n=t.useId()
...
const nf=rt({closable:[Boolean,String],closeText:{type:String,default:"$vuetify.dismiss"},collapsed:Boolean,displayStrategy:{type:String,default:"hold"},modelValue:{type:Array,default:()=>[]},totalVisible:{type:[Number,String],default:1},gap:{type:[Number,String],default:8},...x(af(),["modelValue","collapsed","queueIndex","queueGap"])},"VSnackbarQueue"),of=ft()({name:"VSnackbarQueue",inheritAttrs:!1,props:nf(),emits:{"update:modelValue":e=>!0},setup(e,{attrs:a,emit:l,slots:n}){const{t:r}=sa(),i=function(){const e=t.shallowRef(o?document.visibilityState:"visible")
...
return t.provide(tf,o),o}(e),u=t.shallowRef(!1),{runOpenDelay:c,runCloseDelay:d}=ni({openDelay:0,closeDelay:500},e=>{u.value=e,y()})
let v=0
...
function cf(e,t,a=!1,l=75){if(0===e.length)return""
const n=e.shift(),o=e[e.length-1]
return(a?`M${n.x} ${l-n.x+2} L${n.x} ${n.y}`:`M${n.x} ${n.y}`)+e.map((a,l)=>{const o=e[l+1],r=e[l-1]||n,i=o&&(u=a,c=r,df((s=o).x+c.x)===df(2*u.x)&&df(s.y+c.y)===df(2*u.y))
var s,u,c
if(!o||i)return`L${a.x} ${a.y}`
const d=Math.min(vf(r,a),vf(o,a)),v=d/2<t?d/2:t,p=pf(r,a,v),m=pf(o,a,v)
return`L${p.x} ${p.y}S${a.x} ${a.y} ${m.x} ${m.y}`}).join("")+(a?`L${o.x} ${l-n.x+2} Z`:"")}function df(e){return parseInt(e,10)}function vf(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function pf(e,t,a){const l=e.x-t.x,n=e.y-t.y,o=Math.sqrt(l*l+n*n),r=l/o,i=n/o
return{x:t.x+r*a,y:t.y+i*a}}const mf=rt({fill:Boolean,...rf()},"VTrendline"),ff=ft()({name:"VTrendline",props:mf(),setup(e,{slots:a}){const l=t.useId(),n=t.computed(()=>e.id||`trendline-${l}`),o=t.computed(()=>Number(e.autoDrawDuration)||(e.fill?500:2e3)),r=t.ref(0),i=t.ref(null)
...
return cf(s(f.value,m.value),a,t,parseInt(e.height,10))}t.watch(()=>e.modelValue,async()=>{if(await t.nextTick(),!e.autoDraw||!i.value||c())return
...
return t.createElementVNode("svg",{display:"block","stroke-width":parseFloat(e.lineWidth)??4},[t.createElementVNode("defs",null,[t.createElementVNode("linearGradient",{id:n.value,gradientUnits:"userSpaceOnUse",x1:"left"===e.gradientDirection?"100%":"0",y1:"top"===e.gradientDirection?"100%":"0",x2:"right"===e.gradientDirection?"100%":"0",y2:"bottom"===e.gradientDirection?"100%":"0"},[l.map((e,a)=>t.createElementVNode("stop",{offset:a/Math.max(l.length-1,1),"stop-color":e||"currentColor"},null))])]),u.value&&t.createElementVNode("g",{key:"labels",style:{textAnchor:"middle",dominantBaseline:"mathematical",fill:"currentColor"}},[g.value.map((l,n)=>t.createElementVNode("text",{x:l.x+d.value/2+d.value/2,y:parseInt(e.height,10)-4+(parseInt(e.labelSize,10)||5.25),"font-size":Number(e.labelSize)||7},[a.label?.({index:n,value:l.value})??l.value]))]),t.createElementVNode("path",{ref:i,d:h(e.fill),fill:e.fill?`url(#${n.value})`:"none",stroke:e.fill?"none":`url(#${n.value})`},null),e.fill&&t.createElementVNode("path",{d:h(!1),fill:"none",stroke:e.color??e.gradient?.[0]},null)])})}}),gf=rt({type:{type:String,default:"trend"},...sf(),...mf()},"VSparkline"),hf=ft()({name:"VSparkline",props:gf(),setup(e,{slots:a}){const{textColorClasses:l,textColorStyles:n}=ol(()=>e.color),o=t.computed(()=>Boolean(e.showLabels||e.labels.length>0||!!a?.label)),r=t.computed(()=>{let t=parseInt(e.height,10)
return o.value&&(t+=1.5*parseInt(e.labelSize,10)),t})
It(()=>{const o="trend"===e.type?ff:uf,i="trend"===e.type?ff.filterProps(e):uf.filterProps(e)
return t.createVNode(o,t.mergeProps({key:e.type,class:l.value,style:n.value,viewBox:`0 0 ${e.width} ${parseInt(r.value,10)}`},i),a)})}}),yf=rt({...it(),...Ei({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),bf=ft()({name:"VSpeedDial",props:yf(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=Zt(e,"modelValue"),n=t.ref(),o=t.computed(()=>{const[t,a="center"]=e.location?.split(" ")??[]
return`${t} ${a}`}),r=t.computed(()=>({[`v-speed-dial__content--${o.value.replace(" ","-")}`]:!0}))
return It(()=>{const i=Ii.filterProps(e)
return t.createVNode(Ii,t.mergeProps(i,{modelValue:l.value,"onUpdate:modelValue":e=>l.value=e,class:e.class,style:e.style,contentClass:["v-speed-dial__content",r.value,e.contentClass],location:o.value,ref:n,transition:"fade-transition"}),{...a,default:l=>t.createVNode(Ja,{defaults:{VBtn:{size:"small"}}},{default:()=>[t.createVNode(dl,{appear:!0,group:!0,transition:e.transition},{default:()=>[a.default?.(l)]})]})})}),{}}}),Vf=Symbol.for("vuetify:v-stepper"),wf=rt({color:String,disabled:{type:[Boolean,String],default:!1},prevText:{type:String,default:"$vuetify.stepper.prev"},nextText:{type:String,default:"$vuetify.stepper.next"}},"VStepperActions"),Sf=ft()({name:"VStepperActions",props:wf(),emits:{"click:prev":()=>!0,"click:next":()=>!0},setup(e,{emit:a,slots:l}){const{t:n}=sa()
function o(){a("click:prev")}function r(){a("click:next")}return It(()=>{const a={onClick:o},i={onClick:r}
return t.createElementVNode("div",{class:"v-stepper-actions"},[t.createVNode(Ja,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[l.prev?.({props:a})??t.createVNode(Dn,a,null)]}),t.createVNode(Ja,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[l.next?.({props:i})??t.createVNode(Dn,i,null)]})])}),{}}}),kf=gt("v-stepper-header"),xf=rt({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:_t,default:"$complete"},editable:Boolean,editIcon:{type:_t,default:"$edit"},error:Boolean,errorIcon:{type:_t,default:"$error"},icon:_t,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),Nf=rt({...xf(),...Ol()},"VStepperItem"),Cf=ft()({name:"VStepperItem",directives:{vRipple:An},props:Nf(),emits:{"group:selected":e=>!0},setup(e,{slots:a}){const l=jl(e,Vf,!0),n=t.computed(()=>l?.value.value??e.value),o=t.computed(()=>e.rules.every(e=>!0===e())),r=t.computed(()=>!e.disabled&&e.editable),i=t.computed(()=>!e.disabled&&e.editable),s=t.computed(()=>e.error||!o.value),u=t.computed(()=>e.complete||e.rules.length>0&&o.value),c=t.computed(()=>s.value?e.errorIcon:u.value?e.completeIcon:l.isSelected.value&&e.editable?e.editIcon:e.icon),d=t.computed(()=>({canEdit:i.value,hasError:s.value,hasCompleted:u.value,title:e.title,subtitle:e.subtitle,step:n.value,value:e.value}))
...
return t.withDirectives(t.createElementVNode("button",{class:t.normalizeClass(["v-stepper-item",{"v-stepper-item--complete":u.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":s.value},l?.selectedClass.value]),disabled:!e.editable,type:"button",onClick:function(){l?.toggle()}},[r.value&&Bl(!0,"v-stepper-item"),t.createVNode(Gn,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:o?e.color:void 0,size:24},{default:()=>[a.icon?.(d.value)??(c.value?t.createVNode(Ql,{icon:c.value},null):n.value)]}),t.createElementVNode("div",{class:"v-stepper-item__content"},[v&&t.createElementVNode("div",{key:"title",class:"v-stepper-item__title"},[a.title?.(d.value)??e.title]),p&&t.createElementVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[a.subtitle?.(d.value)??e.subtitle]),a.default?.(d.value)])]),[[An,e.editable&&e.ripple,null]])}),{}}}),Ef=rt({...x(Tc(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),If=ft()({name:"VStepperWindow",props:Ef(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=t.inject(Vf,null),n=Zt(e,"modelValue"),o=t.computed({get:()=>null==n.value&&l?l.items.value.find(e=>l.selected.value.includes(e.id))?.value:n.value,set(e){n.value=e}})
return It(()=>{const l=Dc.filterProps(e)
return t.createVNode(Dc,t.mergeProps({_as:"VStepperWindow"},l,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),a)}),{}}}),_f=rt({...$c()},"VStepperWindowItem"),Pf=ft()({name:"VStepperWindowItem",props:_f(),setup:(e,{slots:a})=>(It(()=>{const l=Mc.filterProps(e)
return t.createVNode(Mc,t.mergeProps({_as:"VStepperWindowItem"},l,{class:["v-stepper-window-item",e.class],style:e.style}),a)}),{})}),Rf=rt({altLabels:Boolean,bgColor:String,completeIcon:_t,editIcon:_t,editable:Boolean,errorIcon:_t,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},nonLinear:Boolean,flat:Boolean,...Po()},"Stepper"),Af=rt({...Rf(),...Ll({mandatory:"force",selectedClass:"v-stepper-item--selected"}),..._i(),...S(wf(),["prevText","nextText"])},"VStepper"),Tf=ft()({name:"VStepper",props:Af(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{items:l,next:n,prev:o,selected:r}=Hl(e,Vf),{displayClasses:i,mobile:s}=Ro(e),{completeIcon:u,editIcon:c,errorIcon:d,color:v,editable:m,prevText:f,nextText:g}=t.toRefs(e),h=t.computed(()=>e.items.map((t,a)=>{const l={title:p(t,e.itemTitle,t),value:p(t,e.itemValue,a+1),...!0===e.itemProps?t:p(t,e.itemProps)}
...
return t.createVNode(Pi,t.mergeProps(l,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":s.value},i.value,e.class],style:e.style}),{default:()=>[r&&t.createVNode(kf,{key:"stepper-header"},{default:()=>[h.value.map(({raw:e,...l},n)=>t.createElementVNode(t.Fragment,null,[!!n&&t.createVNode(Zo,null,null),t.createVNode(Cf,l.props,{default:a[`header-item.${l.value}`]??a.header,icon:a.icon,title:a.title,subtitle:a.subtitle})]))]}),u&&t.createVNode(If,{key:"stepper-window"},{default:()=>[h.value.map(e=>t.createVNode(Pf,{value:e.value},{default:()=>a[`item.${e.value}`]?.(e)??a.item?.(e)}))]}),a.default?.({prev:o,next:n}),c&&(a.actions?.({next:n,prev:o})??t.createVNode(Sf,{key:"stepper-actions","onClick:prev":o,"onClick:next":n},a))]})}),{prev:o,next:n}}}),Df=rt({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...go(),...eo()},"VSwitch"),Bf=ft()({name:"VSwitch",inheritAttrs:!1,props:Df(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,{attrs:a,slots:l}){const n=Zt(e,"indeterminate"),o=Zt(e,"modelValue"),{loaderClasses:r}=sn(e),{isFocused:i,focus:s,blur:c}=so(e),d=t.ref(),v=t.ref(),p=u&&window.matchMedia("(forced-colors: active)").matches,m=t.toRef(()=>"string"==typeof e.loading&&""!==e.loading?e.loading:e.color),f=t.useId(),g=t.toRef(()=>e.id||`switch-${f}`)
...
return t.createVNode(Dn,t.mergeProps({symbol:Mf,ref:s,class:["v-tab",e.class,d.value&&e.inset?r.value:[]],style:[e.style,d.value&&e.inset?i.value:[],{backgroundColor:d.value&&e.inset?"transparent !important":void 0}],tabindex:d.value?0:-1,role:"tab","aria-selected":String(d.value),active:!1},c,l,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":f}),{...a,default:()=>t.createElementVNode(t.Fragment,null,[a.default?.()??e.text,!e.hideSlider&&t.createElementVNode("div",{ref:u,class:t.normalizeClass(["v-tab__slider",e.inset?r.value:n.value]),style:t.normalizeStyle([o.value,e.inset?i.value:n.value])},null)])})}),Vo({},s)}}),Of=rt({...x(Tc(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),jf=ft()({name:"VTabsWindow",props:Of(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=t.inject(Mf,null),n=Zt(e,"modelValue"),o=t.computed({get:()=>null==n.value&&l?l.items.value.find(e=>l.selected.value.includes(e.id))?.value:n.value,set(e){n.value=e}})
return It(()=>{const l=Dc.filterProps(e)
return t.createVNode(Dc,t.mergeProps({_as:"VTabsWindow"},l,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),a)}),{}}}),Hf=rt({...$c()},"VTabsWindowItem"),Wf=ft()({name:"VTabsWindowItem",props:Hf(),setup:(e,{slots:a})=>(It(()=>{const l=Mc.filterProps(e)
return t.createVNode(Mc,t.mergeProps({_as:"VTabsWindowItem"},l,{class:["v-tabs-window-item",e.class],style:e.style}),a)}),{})})
const Uf=rt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,inset:Boolean,insetPadding:[String,Number],insetRadius:[String,Number],sliderColor:String,...S(zf(),["spaced","sliderTransition","sliderTransitionDuration"]),...jo({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Al(),...xa()},"VTabs"),Yf=ft()({name:"VTabs",props:Uf(),emits:{"update:modelValue":e=>!0},setup(e,{attrs:a,slots:l}){const n=Zt(e,"modelValue"),o=t.computed(()=>function(e){return e?e.map(e=>g(e)?e:{text:e,value:e}):[]}(e.items)),{densityClasses:r}=Tl(e),{backgroundColorClasses:i,backgroundColorStyles:s}=rl(()=>e.bgColor),{scopeId:u}=gi()
...
return t.createElementVNode("div",{class:t.normalizeClass([{"v-time-picker-clock__item":!0,"v-time-picker-clock__item--active":l,"v-time-picker-clock__item--disabled":e.disabled||!k(a)},l&&p.value]),style:t.normalizeStyle([I(a),l&&m.value])},[t.createElementVNode("span",null,[e.format(a)])])})])]))}}),og=rt({active:Boolean,color:String,disabled:Boolean,label:String,modelValue:String,error:String,showHint:Boolean,readonly:Boolean},"VTimePickerField"),rg=ft()({name:"VTimePickerField",props:og(),emits:{"update:modelValue":e=>!0},setup(e,{emit:a}){const{textColorClasses:l,textColorStyles:n}=ol(()=>e.color),o=t.ref(),r=t.shallowRef(!1)
...
function ig(e,t=2){return String(e).padStart(t,"0")}function sg(e){return e?(e-1)%12+1:12}function ug(e,t){return e%12+("pm"===t?12:0)}function cg(e){const t=e.replaceAll(/\D/g,"")
return t.length>0?Number(t):null}const dg=rt({allowedHours:[Function,Array],allowedMinutes:[Function,Array],allowedSeconds:[Function,Array],max:String,min:String},"time-validation")
function vg(e){const a=t.computed(()=>{const t=e.min?Number(e.min.split(":")[0]):0,a=e.max?Number(e.max.split(":")[0]):23
...
for(let e=1;e<=c&&!s(t=u(t));e++);return t}}}const pg=rt({ampm:Boolean,color:String,disabled:Boolean,inputHints:Boolean,hour:[Number,String],minute:[Number,String],second:[Number,String],period:String,readonly:Boolean,useSeconds:Boolean,value:Number,viewMode:String,...dg()},"VTimePickerControls"),mg=ft()({name:"VTimePickerControls",props:pg(),emits:{"update:period":e=>!0,"update:viewMode":e=>!0,"update:hour":e=>!0,"update:minute":e=>!0,"update:second":e=>!0},setup(e,{emit:a}){const{t:l}=sa(),{isAllowedHour:n,isAllowedMinute:o,isAllowedSecond:r,findNextAllowed:i}=vg(e),s=t.computed(()=>null!==e.hour?e.ampm?ug(Number(e.hour),e.period??"am"):Number(e.hour):null),u=t.computed(()=>null!==e.minute?Number(e.minute):null),c=t.computed(()=>null===e.hour||(n.value?.(Number(s.value))??!0)),d=t.computed(()=>null===e.minute||(o.value?.(s.value,Number(e.minute))??!0)),v=t.computed(()=>null===e.second||(r.value?.(s.value,u.value,Number(e.second))??!0)),p=t=>{if(null==t||isNaN(Number(t)))return null
const a=Number(t)
return e.ampm?ig(sg(a)):ig(a)},m=t=>{if(isNaN(Number(t))||null==t||""===t)return null
const a="string"==typeof t?cg(t):Number(t)
return null===a?null:e.ampm?ug(a,e.period??"am"):A(a,0,23)},f=Zt(e,"hour",void 0,p,m),g=e=>null==e||isNaN(Number(e))?null:ig(`${e}`),h=e=>{if(isNaN(Number(e))||null==e||""===e)return null
const t="string"==typeof e?cg(e):Number(e)
...
const n="am"===e.period,o=e.ampm?ug(Number(f.value??0),n?"am":"pm"):Number(f.value??0),r=i("hour",o,"ArrowUp"===l.key),s=n&&r>=12||!n&&r<12
e.ampm&&s?(a("update:period","am"===e.period?"pm":"am"),t.nextTick(()=>f.value=ig(r))):f.value=ig(r)}function w(e){if(!["ArrowUp","ArrowDown"].includes(e.key))return
e.preventDefault(),e.stopPropagation()
const t=Number(y.value??0),a=i("minute",t,"ArrowUp"===e.key,s.value)
y.value=ig(a)}function S(e){if(!["ArrowUp","ArrowDown"].includes(e.key))return
e.preventDefault(),e.stopPropagation()
const t=Number(b.value??0),a=i("second",t,"ArrowUp"===e.key,s.value,u.value)
b.value=ig(a)}function k(t,a,l){return n=>{if(!n.data)return
const o=n.target,{value:r,selectionStart:i,selectionEnd:s}=o??{}
if(null===cg(n.data))return void n.preventDefault()
...
if(cg(u)>t)return n.preventDefault(),o.value=ig(String(cg(n.data)).substring(0,2)),void l(o.value)}const c=t(u)
...
r.value=n?ug(parseInt(t,10),n):parseInt(t,10),i.value=parseInt(a,10),s.value=parseInt(l||0,10)}v.value=null==r.value||r.value<12?"am":"pm"}function N(e){"hour"===p.value?r.value=g.value?ug(e,v.value):e:"minute"===p.value?i.value=e:s.value=e}function C(t){switch(p.value||"hour"){case"hour":a("update:hour",t)
break
...
null!==S()&&(u.value=r.value,c.value=i.value,e.useSeconds&&(d.value=s.value),l&&w())}t.watch(r,w),t.watch(i,w),t.watch(s,w),t.watch(v,(e,t)=>{null!=r.value&&e!==t&&("pm"===e&&r.value<12?r.value=r.value+12:"am"===e&&r.value>=12&&(r.value=r.value-12))}),t.watch(()=>e.modelValue,e=>k(e)),t.watch(()=>e.useSeconds,(e,t)=>{t&&!e&&"second"===p.value&&(p.value="minute"),e||null===s.value||(s.value=null)}),t.onMounted(()=>{k(e.modelValue)}),It(()=>{const a=x(md.filterProps(e),["hideHeader"]),u=mg.filterProps(e),c=ng.filterProps(x(e,["format","modelValue","min","max"])),d="hour"===p.value?h.value:"minute"===p.value?e=>y.value(r.value,e):e=>b.value(r.value,i.value,e)
return t.createVNode(md,t.mergeProps(a,{color:void 0,class:["v-time-picker",`v-time-picker--variant-${e.variant}`,e.class,o.value],hideHeader:e.hideHeader&&"input"!==e.variant,style:e.style}),{title:()=>l.title?.()??t.createElementVNode("div",{class:"v-time-picker__title"},[n(e.title)]),header:()=>t.createVNode(mg,t.mergeProps(u,{ampm:g.value,hour:r.value,minute:i.value,period:v.value,second:s.value,viewMode:p.value,inputHints:"input"===e.variant,"onUpdate:hour":e=>r.value=e,"onUpdate:minute":e=>i.value=e,"onUpdate:second":e=>s.value=e,"onUpdate:period":e=>v.value=e,"onUpdate:viewMode":e=>p.value=e,ref:m}),null),default:()=>t.createVNode(ng,t.mergeProps(c,{allowedValues:d,double:"hour"===p.value&&!g.value,format:"hour"===p.value?g.value?sg:e=>e:e=>ig(e,2),max:"hour"===p.value?g.value&&"am"===v.value?11:23:59,min:"hour"===p.value&&g.value&&"pm"===v.value?12:0,size:20,step:"hour"===p.value?1:5,modelValue:"hour"===p.value?r.value:"minute"===p.value?i.value:s.value,onChange:C,onInput:N,ref:f}),null),actions:l.actions})})}}),hg=rt({...it(),...Fl({variant:"text"})},"VToolbarItems"),yg=ft()({name:"VToolbarItems",props:hg(),setup:(e,{slots:a})=>(vt({VBtn:{color:t.toRef(()=>e.color),height:"inherit",variant:t.toRef(()=>e.variant)}}),It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-toolbar-items",e.class]),style:t.normalizeStyle(e.style)},[a.default?.()])),{})}),bg=rt({id:String,interactive:Boolean,text:String,...x(Ni({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:null}),["absolute","retainFocus","captureFocus","disableInitialFocus"])},"VTooltip"),Vg=ft()({name:"VTooltip",props:bg(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=Zt(e,"modelValue"),{scopeId:n}=gi(),o=t.useId(),r=t.toRef(()=>e.id||`v-tooltip-${o}`),i=t.ref(),s=t.computed(()=>e.location.split(" ").length>1?e.location:e.location+" center"),u=t.computed(()=>"auto"===e.origin||"overlap"===e.origin||e.origin.split(" ").length>1||e.location.split(" ").length>1?e.origin:e.origin+" center"),c=t.toRef(()=>null!=e.transition?e.transition:l.value?"scale-transition":"fade-transition"),d=t.computed(()=>t.mergeProps({"aria-describedby":r.value},e.activatorProps))
return It(()=>{const o=Ci.filterProps(e)
return t.createVNode(Ci,t.mergeProps({ref:i,class:["v-tooltip",{"v-tooltip--interactive":e.interactive},e.class],style:e.style,id:r.value},o,{modelValue:l.value,"onUpdate:modelValue":e=>l.value=e,transition:c.value,absolute:!0,location:s.value,origin:u.value,role:"tooltip",activatorProps:d.value,_disableGlobalStack:!0},n),{activator:a.activator,default:(...t)=>a.default?.(...t)??e.text})}),Vo({},i)}}),wg=rt({...x(fr({collapseIcon:"$treeviewCollapse",expandIcon:"$treeviewExpand"}),["subgroup"])},"VTreeviewGroup"),Sg=ft()({name:"VTreeviewGroup",props:wg(),setup(e,{slots:a}){const l=t.ref(),n=t.computed(()=>l.value?.isOpen?e.collapseIcon:e.expandIcon),o=t.computed(()=>({VTreeviewItem:{prependIcon:void 0,appendIcon:void 0,toggleIcon:n.value}}))
return It(()=>{const n=gr.filterProps(e)
return t.createVNode(gr,t.mergeProps(n,{ref:l,class:["v-treeview-group",e.class],subgroup:!0}),{...a,activator:a.activator?e=>t.createElementVNode(t.Fragment,null,[t.createVNode(Ja,{defaults:o.value},{default:()=>[a.activator?.(e)]})]):void 0})}),{}}}),kg=Symbol.for("vuetify:v-treeview"),xg=rt({loading:Boolean,hideActions:Boolean,hasCustomPrepend:Boolean,indentLines:Array,toggleIcon:_t,...Vr({slim:!0})},"VTreeviewItem"),Ng=ft()({name:"VTreeviewItem",props:xg(),emits:{toggleExpand:e=>!0},setup(e,{slots:a,emit:l}){const n=t.inject(kg,{visibleIds:t.ref()}).visibleIds,o=t.ref(),r=t.computed(()=>o.value?.root.activatable.value&&o.value?.isGroupActivator),i=t.computed(()=>o.value?.link.isClickable.value||null!=e.value&&!!o.value?.list),s=t.computed(()=>!e.disabled&&!1!==e.link&&(e.link||i.value||r.value)),u=t.computed(()=>n.value&&!n.value.has(t.toRaw(o.value?.id)))
...
return l}return t.provide(kg,{visibleIds:h}),vt({VTreeviewGroup:{activeColor:r,baseColor:i,color:s,collapseIcon:t.toRef(()=>e.collapseIcon),expandIcon:t.toRef(()=>e.expandIcon)},VTreeviewItem:{activeClass:t.toRef(()=>e.activeClass),activeColor:r,baseColor:i,color:s,density:t.toRef(()=>e.density),disabled:t.toRef(()=>e.disabled),lines:t.toRef(()=>e.lines),variant:t.toRef(()=>e.variant)}}),It(()=>{const l=Fr.filterProps(e),r=Eg.filterProps(e),i="boolean"==typeof e.indentLines?"default":e.indentLines
return t.createVNode(Fr,t.mergeProps({ref:v},l,{class:["v-treeview",{"v-treeview--fluid":e.fluid},e.class],role:"tree",openStrategy:"multiple",style:[{"--v-treeview-indent-line-color":e.indentLinesColor,"--v-treeview-indent-line-opacity":e.indentLinesOpacity},e.style],opened:p.value,activated:u.value,"onUpdate:activated":e=>u.value=e,selected:d.value,"onUpdate:selected":e=>d.value=e}),{default:()=>[0===h.value?.size&&!e.hideNoData&&(a["no-data"]?.()??t.createVNode(wr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Eg,t.mergeProps(r,{density:e.density,returnObject:e.returnObject,items:o.value,parentIndentLines:e.indentLines?[]:void 0,indentLinesVariant:i}),a)]})}),{}}}),Rg=ft()({name:"VValidation",props:mo(),emits:{"update:modelValue":e=>!0},setup(e,{slots:t}){const a=fo(e,"validation")
return()=>t.default?.(a)}})
var Ag=Object.freeze({__proto__:null,VAlert:Hn,VAlertTitle:Mn,VApp:ka,VAppBar:Pl,VAppBarNavIcon:Fn,VAppBarTitle:$n,VAutocomplete:cs,VAvatar:Gn,VBadge:Un,VBanner:fs,VBannerActions:vs,VBannerText:ps,VBottomNavigation:hs,VBottomSheet:ws,VBreadcrumbs:Es,VBreadcrumbsDivider:ks,VBreadcrumbsItem:Ns,VBtn:Dn,VBtnGroup:zl,VBtnToggle:Gl,VCalendar:hc,VCard:Ic,VCardActions:bc,VCardItem:xc,VCardSubtitle:wc,VCardText:Cc,VCardTitle:Sc,VCarousel:Fc,VCarouselItem:Lc,VCheckbox:So,VCheckboxBtn:lo,VChip:Ko,VChipGroup:Yo,VClassIcon:Bt,VCode:Oc,VCol:Qv,VColorPicker:fd,VCombobox:hd,VComponentIcon:At,VConfirmEdit:bd,VContainer:Wv,VCounter:Ai,VDataIterator:tv,VDataTable:Mv,VDataTableFooter:ov,VDataTableHeaders:xv,VDataTableRow:Iv,VDataTableRows:Pv,VDataTableServer:jv,VDataTableVirtual:Lv,VDatePicker:Cp,VDatePickerControls:mp,VDatePickerHeader:gp,VDatePickerMonth:Vp,VDatePickerMonths:Sp,VDatePickerYears:xp,VDefaultsProvider:Ja,VDialog:bs,VDialogBottomTransition:$a,VDialogTopTransition:Ma,VDialogTransition:Ta,VDivider:Zo,VEmptyState:Ip,VExpandBothTransition:Za,VExpandTransition:qa,VExpandXTransition:Xa,VExpansionPanel:Bp,VExpansionPanelText:Rp,VExpansionPanelTitle:Tp,VExpansionPanels:Mp,VFab:Lp,VFabTransition:Fa,VFadeTransition:za,VField:$i,VFieldLabel:Di,VFileInput:Up,VFooter:Gp,VForm:qp,VHotkey:om,VHover:im,VIcon:Ql,VImg:gl,VInfiniteScroll:cm,VInput:ho,VItem:mm,VItemGroup:pm,VKbd:Zp,VLabel:qn,VLayout:gm,VLayoutItem:ym,VLazy:Vm,VLigatureIcon:Dt,VList:Fr,VListGroup:gr,VListImg:$r,VListItem:wr,VListItemAction:zr,VListItemMedia:Or,VListItemSubtitle:yr,VListItemTitle:br,VListSubheader:kr,VLocaleProvider:Sm,VMain:xm,VMenu:Ii,VMessages:ro,VNavigationDrawer:Rm,VNoSsr:Am,VNumberInput:Dm,VOtpInput:Fm,VOverlay:Ci,VPagination:lv,VParallax:Mm,VProgressCircular:an,VProgressLinear:on,VRadio:Lm,VRadioGroup:jm,VRangeSlider:Wm,VRating:Ym,VResponsive:ll,VRow:dp,VScaleTransition:La,VScrollXReverseTransition:ja,VScrollXTransition:Oa,VScrollYReverseTransition:Wa,VScrollYTransition:Ha,VSelect:ss,VSelectionControl:to,VSelectionControlGroup:Jn,VSheet:Pi,VSkeletonLoader:Jm,VSlideGroup:Ho,VSlideGroupItem:ef,VSlideXReverseTransition:Ya,VSlideXTransition:Ua,VSlideYReverseTransition:Ka,VSlideYTransition:Ga,VSlider:rd,VSnackbar:lf,VSnackbarQueue:of,VSpacer:vp,VSparkline:hf,VSpeedDial:bf,VStepper:Tf,VStepperActions:Sf,VStepperHeader:kf,VStepperItem:Cf,VStepperWindow:If,VStepperWindowItem:Pf,VSvgIcon:Tt,VSwitch:Bf,VSystemBar:$f,VTab:Lf,VTable:Av,VTabs:Yf,VTabsWindow:jf,VTabsWindowItem:Wf,VTextField:Hi,VTextarea:Kf,VThemeProvider:Xf,VTimePicker:gg,VTimePickerClock:ng,VTimePickerControls:mg,VTimeline:ag,VTimelineItem:eg,VToolbar:Cl,VToolbarItems:yg,VToolbarTitle:Ca,VTooltip:Vg,VTreeview:Pg,VTreeviewGroup:Sg,VTreeviewItem:Ng,VValidation:Rg,VVirtualScroll:qi,VWindow:Dc,VWindowItem:Mc})
function Tg(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const Dg={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:n,immediate:o,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver((a=[],l)=>{s?.(a,l),n&&Tg(e,t)})
o&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:Tg}
function Bg(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,n="object"==typeof l&&l.options||{passive:!0},o="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",o,n),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:o,options:n,target:a?void 0:r})}function Fg(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:n=e}=e._onScroll[t.instance.$.uid]
n.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const $g={mounted:Bg,unmounted:Fg,updated:function(e,t){t.value!==t.oldValue&&(Fg(e,t),Bg(e,t))}}
const Mg=function(e,a){const n=function(e,a){return function(n,o,r){const i="function"==typeof a?a(o):a,s=o.value?.text??o.value??i?.text,u=g(o.value)?o.value:{},c=()=>s??n.textContent,d=(r.ctx===o.instance.$?function(e,t){const a=new Set,n=t=>{for(const l of t){if(!l)continue
...
return t.nextTick(()=>a.update()),u.mount=e,n}}("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&u.mixin({computed:{$vuetify(){return t.reactive({defaults:jg.call(this,ct),display:jg.call(this,xo),theme:jg.call(this,da),icons:jg.call(this,Pt),locale:jg.call(this,ra),date:jg.call(this,Cu)})}}})},unmount:function(){u.stop()},defaults:e,display:a,theme:l,icons:c,locale:d,date:v,goTo:p}})}function jg(e){const t=this.$,a=t.parent?.provides??t.vnode.appContext?.provides
if(a&&e in a)return a[e]}Og.version="4.0.8"
const Hg=(e={})=>Og({components:Ag,directives:zg,...e}),Wg="4.0.8"
Hg.version=Wg,e.blueprints=Ot,e.components=Ag,e.createVuetify=Hg,e.directives=zg,e.useDate=Iu,e.useDefaults=function(e={},t){const{props:a,provideSubDefaults:l}=pt(e,t)
...
return e&&("INPUT"===e.tagName||"TEXTAREA"===e.tagName||e.isContentEditable||"true"===e.contentEditable)}())if(Uu(e,l,u))if(t.toValue(i)&&e.preventDefault(),v){if(clearTimeout(d),p++,p===c.length)return a(e),void m()
d=window.setTimeout(m,t.toValue(s))}else a(e)
else v&&m()}function g(){window.removeEventListener(t.toValue(n),f),clearTimeout(d)}return t.watch(()=>t.toValue(e),e=>{if(g(),e){const a=zu(e.toLowerCase())
if(a){const e="string"!=typeof a&&"sequence"===a.type?a.parts:[a]
v=e.length>1,c=e,m(),window.addEventListener(t.toValue(n),f)}}},{immediate:!0}),t.watch(()=>t.toValue(n),(e,t)=>{t&&c&&c.length>0&&(window.removeEventListener(t,f),window.addEventListener(e,f))}),t.onScopeDispose(g,!0),g},e.useLayout=Gt,e.useLocale=sa,e.useMask=function(e){const a=t.computed(()=>"string"==typeof e.mask?e.mask in Yu?Yu[e.mask]:e.mask:e.mask?.mask??""),l=t.computed(()=>({...Gu,...g(e.mask)?e.mask.tokens:null}))
...
else n[t]=!1,t++}return n}function c(e){return!!e&&s(e)===s(i(e))}return{isDelimiter:function(e,t){return!(!a.value.length||!e.length)&&!!u(e)[t]},isValid:c,isComplete:function(e){return!!e&&(i(e).length===a.value.length&&c(e))},mask:i,unmask:s}},e.useRtl=ca,e.useTheme=wa,e.version=Wg})
